...
| JS tools (canvas breathing, fractal, eye movement…) | assets/js/tools-*.js, tools/*.html, assets/css-tools | frontend-design, debugging-and-error-recovery |
...
| Creating new local skills | skill-creator (from anthropics/skills) | skill-creator |
