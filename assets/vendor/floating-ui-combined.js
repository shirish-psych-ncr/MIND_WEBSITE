!((t, e) => {
	...
	function H(t, n, o, i) {
		...
		return e.rectToClientRect({ width: p, height: g, x: d, y: h });
	}
	function P(t) {
		return H(f(t)).left + b(t).scrollLeft;
	}
	function W(t, n, i) {
		let r;
		if ("viewport" === n)
	...
	function M(t, e) {
		const n = T(t);
		return (
			!(n === e || !a(n) || v(n)) && ("fixed" === x(n).position || M(n, e))
		);
	}
	function z(t, e, n) {
		const o = d(e),
	...
	function N(t, e) {
		...
		let o = V(t, e);
		for (; o && g(o) && A(o); ) o = V(o, e);
		return o && v(o) && A(o) && !y(o)
			? n
			: o ||
					((t) => {
						let e = T(t);
	...
	const B = {
		convertOffsetParentRelativeRectToViewportRelativeRect: (t) => {
			...
			if (
				(y || (!y && !r)) &&
				(("body" !== l(o) || p(s)) && (a = b(o)), d(o))
			) {
				const t = H(o);
				(h = F(o)), (g.x = t.x + o.clientLeft), (g.y = t.y + o.clientTop);
			}
			return {
				width: n.width * h.x,
				height: n.height * h.y,
				x: n.x * h.x - a.scrollLeft * h.x + g.x,
				y: n.y * h.y - a.scrollTop * h.y + g.y,
			};
		},
		getDocumentElement: f,
		getClippingRect: function (t) {
			const { element: e, boundary: i, rootBoundary: r, strategy: c } = t;
			const s = [
					...("clippingAncestors" === i
						? m(e)
							? []
							: ((t, e) => {
									const n = e.get(t);
									if (n) return n;
									let o = R(t, [], !1).filter((t) => a(t) && "body" !== l(t)),
										i = null;
									const r = "fixed" === x(t).position;
									let c = r ? T(t) : t;
									for (; a(c) && !v(c); ) {
										const e = x(c),
											n = y(c);
		...
		getElementRects: async function (t) {
			const e = this.getOffsetParent || N,
		...
		getDimensions: (t) => {
			const { width: e, height: n } = E(t);
			return { width: e, height: n };
		},
		getScale: F,
		isElement: a,
		isRTL: (t) => "rtl" === x(t).direction,
	};
	const I = e.detectOverflow,
		k = e.offset,
		q = e.autoPlacement,
		U = e.shift,
		j = e.flip,
							...
							return (
								(function f(u, a) {
									...
									try {
										...
										c = new IntersectionObserver(w, m);
									}
									c.observe(t);
								})(!0),
								s
...
!((t, e) => {
	...
	function x(t) {
		return "number" !== typeof t
			? ((t) => ({ top: 0, right: 0, bottom: 0, left: 0, ...t }))(t)
	...
	function b(t, e, n) {
		const { reference: i, floating: o } = t;
		const r = g(e),
			a = p(e),
			l = d(a),
			s = c(e),
				...
				async fn(e) {
					...
					if (
						...
						const t = r(h.left, 0),
							...
							i = r(h.bottom, 0);
						x
							? (C = v - 2 * (0 !== t || 0 !== e ? t + e : r(h.left, h.right)))
							: (k = b - 2 * (0 !== n || 0 !== i ? n + i : r(h.top, h.bottom)));
					}
