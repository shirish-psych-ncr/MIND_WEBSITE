	...
	(t = () => {
		...
		function M(e) {
			return (
				!0 === e ||
				!1 === e ||
				(((e) => b(e) && null !== e)(e) && "[object Boolean]" === S(e))
			);
		}
		function b(e) {
			return "object" === n(e);
		...
		const L = (e) => "Missing ".concat(e, " property in key"),
			_ = (e) =>
						...
						},
						{
							...
							value: function (e, t) {
								...
								this.keys.forEach((t, i) => {
									const o = t.getFn ? t.getFn(e) : this.getFn(e, t.path);
									if (x(o))
										if (g(o)) {
											for (
												...
												if (x(h))
													if (m(h) && !w(h)) {
														const l = { v: h, i: u, n: this.norm.get(h) };
														c.push(l);
													} else
														g(h) &&
															h.forEach((e, t) => {
		...
		function T(e, t, n) {
			...
			for (
				...
				if (((x = Math.min(_, x)), (w = m + k), S))
					for (let O = 0; O < k; ) (L[m + O] = 1), (O += 1);
			}
			w = -1;
			for (
				var j = [], A = 1, I = k + M, C = 1 << (k - 1), E = 0;
				E < k;
				E += 1
			) {
				for (var F = 0, R = I; F < R; )
			...
			const B = { isMatch: w >= 0, score: Math.max(0.001, A) };
			if (S) {
				const J = (function () {
					for (
						var e =
		...
		const D = (() => {
				function e(t) {
					...
					if (
						...
						const b = (e, t) => {
								this.chunks.push({ pattern: e, alphabet: z(e), startIndex: t });
							},
		...
		const B = ((e) => {
			...
			Q = ((e) => {
				...
				function n(e) {
					...
					return (
						r(this, n),
						((i = t.call(this, e))._bitapSearch = new D(e, {
							location: a,
							threshold: u,
							distance: l,
							includeMatches: d,
						...
						[
							{
								...
								value: function (e) {
									...
									for (
										...
										const u = t[a];
										(o.length = 0), (i = 0);
										for (let h = 0, l = u.length; h < l; h += 1) {
											const d = u[h],
												v = d.search(e),
												g = v.isMatch,
												y = v.indices,
			...
			re = [];
		function ie(e, t) {
			for (let n = 0, r = re.length; n < r; n += 1) {
				const i = re[n];
				...
				(function e(n) {
					...
					if (((e) => !g(e) && b(e) && !ue(e))(n)) {
						const c = o ? n[ae] : i[0],
							a = o ? n[se] : n[c];
						if (!m(a))
							throw new Error(((e) => "Invalid value for key ".concat(e))(c));
						const s = { keyId: C(c), pattern: a };
						return r && (s.searcher = ie(a, t)), s;
					}
					const u = { children: [], operator: i[0] };
					return (
						i.forEach((t) => {
							const r = n[t];
							g(r) &&
							...
							const t = this,
								...
								r = function e(n, r, i) {
									if (!n.children) {
										...
										return a?.length ? [{ idx: i, item: r, matches: a }] : [];
									}
									for (
