						...
						? ((e) => {
								...
								if ("function" !== typeof a) {
									const t = n.left - i.left,
										o = n.top - i.top,
										[s, l, d, c] = T(e, n, i),
										u = { transform: `translate(${t}px, ${o}px)` },
								...
								o.set(e, r),
									t.set(e, i),
									r.addEventListener("finish", w.bind(null, e));
							})(e)
						: a && !r
							? ((e) => {
									let i;
									...
									const s = window.scrollX,
										l = window.scrollY;
									a?.parentNode && a.parentNode instanceof Element
									...
									if (k(w)) {
										...
										!1 !== (null == n ? void 0 : n.styleReset) &&
											((b = (null == n ? void 0 : n.styleReset) || b),
					...
					((e) => {
						...
						const { offsetWidth: a, offsetHeight: s } = d,
							...
							c = new IntersectionObserver(
								...
								{ root: d, threshold: 1, rootMargin: l },
							);
...
function x(e, t) {
	t || f in e
		? t && !(f in t) && Object.defineProperty(t, f, { value: e })
		: Object.defineProperty(e, f, { value: e });
}
function M(e) {
...
function T(e, t, n) {
	...
	if ("content-box" === s.getPropertyValue("box-sizing")) {
		const e =
				...
				M(s.paddingBottom) +
				M(s.borderTopWidth) +
				M(s.borderBottomWidth),
			t =
				M(s.paddingLeft) +
				M(s.paddingRight) +
				M(s.borderRightWidth) +
				M(s.borderLeftWidth);
		(o -= t), (r -= t), (i -= e), (a -= e);
	}
...
function j(e, r) {
	...
	e.remove(),
		...
		setTimeout(() => {
			if (
				(p in e && delete e[p],
				Object.defineProperty(e, h, { value: !0, configurable: !0 }),
...
export { A as default, B as vAutoAnimate, T as getTransitionSizes };
