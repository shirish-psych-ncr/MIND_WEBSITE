...
const pn = Object.defineProperty,
	hn = (e, t, n) =>
		t in e
			? pn(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n })
			: (e[t] = n),
	...
	_PetiteVue = ((e) => {
		...
		const l = Object.assign,
			...
			_ = /-(\w)/g,
			w = x((e) => e.replace(_, (_e, t) => (t ? t.toUpperCase() : ""))),
			$ = /\B([A-Z])/g,
		...
		class W {
					...
					try {
						return (
							...
							R <= 30
								? (({ deps: e }) => {
										if (e.length)
											for (let t = 0; t < e.length; t++) e[t].w |= N;
									})(this)
								: I(this),
							this.fn()
						);
			...
			stop() {
				this.active && (I(this), this.onStop?.(), (this.active = !1));
			}
		}
		function I(e) {
			const { deps: t } = e;
		...
		const Y = {
				...
				ownKeys: (e) => (H(e, 0, a(e) ? "length" : B), Reflect.ownKeys(e)),
			},
			ee = { get: U, set: (_e, _t) => !0, deleteProperty: (_e, _t) => !0 },
			te = new WeakMap(),
			ne = new WeakMap(),
			se = new WeakMap(),
			re = new WeakMap();
		...
		function oe(e) {
			return e?.__v_isReadonly ? e : ce(e, !1, Y, null, te);
		}
		...
		const ae = [],
				...
				"class" === s && (e._class = e.className),
					n(() => {
						...
						if (s) (null == r ? void 0 : r.camel) && (s = w(s)), ye(e, s, n, i);
							...
							for (const t in n) ye(e, t, n[t], i?.[t]);
			...
			Ce = (e) =>
				null == e ? "" : g(e) ? JSON.stringify(e, null, 2) : String(e),
						...
						if (
							(([b, x] = ((e) => {
								const t = new Map(),
									n = [];
								if (a(e))
									for (let s = 0; s < e.length; s++) n.push(w(t, e[s], s));
		...
		const De = (e, t) => {
				...
				const t = {
					...
					effect: (e) => {
						...
						const n = ((e, t) => {
							...
							const n = new W(e);
							t && (l(n, t), t.scope && S(n, t.scope)), !t?.lazy && n.run();
			...
			et = (e, t = {}) => {
				...
				const r = oe(
					new Proxy(s, {
						set: (e, t, s, i) =>
							i !== r || Object.hasOwn(e, t)
								? Reflect.set(e, t, s, i)
								: Reflect.set(n, t, s),
					}),
				);
				return tt(r), { ...e, scope: r };
			},
			tt = (e) => {
			...
			insert(e, t = null) {
				if (this.isFragment)
					if (this.start) {
						...
						for (
							;
							s && ((n = s.nextSibling), e.insertBefore(s, t), s !== this.end);
						)
							s = n;
					} else
						(this.start = new Text("")),
