...
((a, i) => {
	...
	const i = {
		...
		UA = (t) => {
			for (const h in t)
				if (h.startsWith("aria-") || h === "role" || h === "title") return !0;
			return !1;
		},
		OA = (...t) =>
			t
				.filter((h, d, c) => !!h && h.trim() !== "" && c.indexOf(h) === d)
				.join(" ")
				.trim(),
		ZA = (t) =>
			t.replace(/^([A-Z])|[\s-_]+(\w)/g, (_h, d, c) =>
				...
				: !t?.class
					...
					: t.class && typeof t.class === "string"
						...
						: t.class && Array.isArray(t.class)
							? t.class
							: "",
		za = (t, { nameAttr: h, icons: d, attrs: c }) => {
			...
			const fa = WA(t),
				EA = UA(fa) ? {} : { "aria-hidden": "true" },
				qA = { ...i, "data-lucide": M, ...EA, ...c, ...fa },
				IA = Ba(fa),
				XA = Ba(c),
				TA = OA("lucide", `lucide-${M}`, ...IA, ...XA);
			TA && Object.assign(qA, { class: TA });
			const jA = Pa(La, qA);
			return t.parentNode?.replaceChild(jA, t);
		},
		Da = [
		...
		Z4 = [["path", { d: "m7 7 10 10-5 5V2l5 5L7 17" }]],
		G4 = [
			[
				"path",
				{
		...
		ud = [["path", { d: "m15 18-6-6 6-6" }]],
		Ad = [["path", { d: "m9 18 6-6-6-6" }]],
		Hd = [["path", { d: "m18 15-6-6-6 6" }]],
		Vd = [
		...
		Jc = [["ellipse", { cx: "12", cy: "12", rx: "10", ry: "6" }]],
		Yc = [["path", { d: "M12 2C8 2 4 8 4 14a8 8 0 0 0 16 0c0-6-4-12-8-12" }]],
		R1 = [
			["circle", { cx: "12", cy: "12", r: "1" }],
		...
		J7 = [["path", { d: "M2 16s9-15 20-4C11 23 2 8 2 8" }]],
		Y7 = [
			[
				"path",
				{
		...
		w2 = [["path", { d: "M21 12a9 9 0 1 1-6.219-8.56" }]],
		zi = [
		...
		be = [["path", { d: "m8 3 4 8 5-5 5 15H2L8 3z" }]],
		qe = [
		...
		er = [["polygon", { points: "12 2 19 21 12 17 5 21 12 2" }]],
		rr = [
			["path", { d: "M8.43 8.43 3 11l8 2 2 8 2.57-5.43" }],
			["path", { d: "M17.39 11.73 22 2l-9.73 4.61" }],
			["line", { x1: "2", x2: "22", y1: "2", y2: "22" }],
		],
		or = [["polygon", { points: "3 11 22 2 13 21 11 13 3 11" }]],
		vr = [
		...
		Xv = [["rect", { width: "20", height: "12", x: "2", y: "6", rx: "2" }]],
		jv = [["rect", { width: "12", height: "20", x: "6", y: "2", rx: "2" }]],
		Nv = [
			[
				"path",
				{
		...
		By = [["path", { d: "M22 17v1c0 .5-.5 1-1 1H3c-.5 0-1-.5-1-1v-1" }]],
		zy = [
			["path", { d: "M12 18v4" }],
			[
				"path",
		...
		cs = [["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2" }]],
		Ms = [
		...
		Dg = [["path", { d: "M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z" }]],
		Fg = [
			[
				"path",
				{
		...
		EC = [["path", { d: "M15 7h2a5 5 0 0 1 0 10h-2m-6 0H7A5 5 0 0 1 7 7h2" }]],
		IC = [
			["path", { d: "m19 5 3-3" }],
			["path", { d: "m2 22 3-3" }],
			[
	...
	const RA = Object.freeze({
		...
		AlertTriangle: ra,
		AlignCenter: ca,
		AlignCenterHorizontal: Ia,
		AlignCenterVertical: Xa,
		AlignEndHorizontal: ja,
		AlignEndVertical: Na,
		AlignHorizontalDistributeCenter: Ka,
		AlignHorizontalDistributeEnd: Qa,
		AlignHorizontalDistributeStart: Ja,
		AlignHorizontalJustifyCenter: Ya,
		AlignHorizontalJustifyEnd: _a,
		AlignHorizontalJustifyStart: xa,
		AlignHorizontalSpaceAround: at,
		AlignHorizontalSpaceBetween: tt,
		AlignJustify: pa,
		AlignLeft: s,
		AlignRight: Ma,
		AlignStartHorizontal: ht,
		AlignStartVertical: dt,
		AlignVerticalDistributeCenter: ct,
		AlignVerticalDistributeEnd: Mt,
		AlignVerticalDistributeStart: pt,
		AlignVerticalJustifyCenter: lt,
		AlignVerticalJustifyEnd: it,
		AlignVerticalJustifyStart: nt,
		AlignVerticalSpaceAround: et,
		AlignVerticalSpaceBetween: rt,
		Ambulance: vt,
		Ampersand: ot,
		Ampersands: $t,
		Amphora: mt,
		...
		ArrowDownAz: A,
		ArrowDownCircle: Q,
		ArrowDownFromLine: Ot,
		ArrowDownLeft: Zt,
		ArrowDownLeftFromCircle: _,
		ArrowDownLeftFromSquare: i0,
		ArrowDownLeftSquare: c0,
		ArrowDownNarrowWide: Gt,
		ArrowDownRight: Wt,
		ArrowDownRightFromCircle: Y,
		ArrowDownRightFromSquare: n0,
		...
		ArrowLeft: Jt,
		ArrowLeftCircle: J,
		ArrowLeftFromLine: Kt,
		ArrowLeftRight: Nt,
		ArrowLeftSquare: l0,
		ArrowLeftToLine: Qt,
		ArrowRight: ah,
		ArrowRightCircle: t1,
		ArrowRightFromLine: Yt,
		ArrowRightLeft: _t,
		ArrowRightSquare: o0,
		ArrowRightToLine: xt,
		ArrowUp: eh,
		...
		ArrowUpRightSquare: m0,
		ArrowUpSquare: $0,
		ArrowUpToLine: ih,
		ArrowUpWideNarrow: nh,
		ArrowUpZA: L,
		ArrowUpZa: L,
		ArrowsUpFromLine: rh,
		Asterisk: oh,
		...
		BellPlus: u4,
		BellRing: A4,
		BetweenHorizonalEnd: B,
		BetweenHorizonalStart: z,
		BetweenHorizontalEnd: B,
		BetweenHorizontalStart: z,
		BetweenVerticalEnd: w4,
		BetweenVerticalStart: V4,
		BicepsFlexed: S4,
		Bike: f4,
		Binary: L4,
		Binoculars: k4,
		...
		Blocks: q4,
		Bluetooth: Z4,
		BluetoothConnected: T4,
		BluetoothOff: U4,
		BluetoothSearching: O4,
		Bold: G4,
		Bolt: E4,
		Bomb: W4,
		Bone: X4,
		...
		BrickWallShield: q5,
		Briefcase: G5,
		BriefcaseBusiness: U5,
		BriefcaseConveyorBelt: O5,
		BriefcaseMedical: Z5,
		BringToFront: W5,
		Broccoli: E5,
		Brush: X5,
		...
		ChartBar: T,
		ChartBarBig: q,
		ChartBarDecreasing: J3,
		ChartBarIncreasing: Y3,
		ChartBarStacked: _3,
		ChartCandlestick: U,
		ChartColumn: G,
		ChartColumnBig: O,
		ChartColumnDecreasing: x3,
		ChartColumnIncreasing: Z,
		ChartColumnStacked: ad,
		ChartGantt: td,
		ChartLine: W,
		ChartNetwork: hd,
		ChartNoAxesColumn: I,
		ChartNoAxesColumnDecreasing: dd,
		ChartNoAxesColumnIncreasing: E,
		ChartNoAxesCombined: cd,
		ChartNoAxesGantt: X,
		ChartPie: j,
		ChartScatter: N,
		ChartSpline: Md,
		...
		ChevronLeftSquare: V0,
		ChevronRight: Ad,
		ChevronRightCircle: l1,
		ChevronRightSquare: w0,
		ChevronUp: Hd,
		ChevronUpCircle: i1,
		ChevronUpSquare: L0,
		ChevronsDown: wd,
		ChevronsDownUp: Vd,
		ChevronsLeft: fd,
		ChevronsLeftRight: Ld,
		ChevronsLeftRightEllipsis: Sd,
		ChevronsRight: Pd,
		ChevronsRightLeft: kd,
		ChevronsUp: zd,
		ChevronsUpDown: Bd,
		Church: Dd,
		Cigarette: Rd,
		...
		CircleArrowDown: Q,
		CircleArrowLeft: J,
		CircleArrowOutDownLeft: _,
		CircleArrowOutDownRight: Y,
		...
		DatabaseX: x8,
		DatabaseZap: ac,
		DecimalsArrowLeft: cc,
		DecimalsArrowRight: hc,
		Delete: dc,
		Dessert: Mc,
		Diameter: pc,
		Diamond: nc,
		...
		FunnelPlus: tM,
		FunnelX: e2,
		GalleryHorizontal: cM,
		GalleryHorizontalEnd: dM,
		GalleryThumbnails: MM,
		GalleryVertical: lM,
		GalleryVerticalEnd: pM,
		Gamepad: eM,
		Gamepad2: iM,
		GamepadDirectional: nM,
		GanttChart: X,
		GanttChartSquare: m,
		Gauge: rM,
		GaugeCircle: e1,
		...
		GitMergeConflict: LM,
		GitPullRequest: DM,
		GitPullRequestArrow: fM,
		GitPullRequestClosed: kM,
		GitPullRequestCreate: BM,
		GitPullRequestCreateArrow: PM,
		GitPullRequestDraft: zM,
		GlassWater: FM,
		Glasses: RM,
		Globe: ZM,
		Globe2: F1,
		...
		ListCheck: ei,
		ListChecks: ri,
		ListChevronsDownUp: oi,
		ListChevronsUpDown: vi,
		ListCollapse: $i,
		ListEnd: mi,
		ListFilter: si,
		ListFilterPlus: yi,
		...
		ListPlus: Ai,
		ListRestart: Hi,
		ListSortAscending: Vi,
		ListSortDescending: Si,
		ListStart: wi,
		ListTodo: Li,
		ListTree: fi,
		ListVideo: ki,
		...
		Merge: kn,
		MessageCircle: On,
		MessageCircleCheck: Pn,
		MessageCircleCode: Bn,
		MessageCircleDashed: zn,
		MessageCircleHeart: Dn,
		MessageCircleMore: Fn,
		MessageCircleOff: Rn,
		MessageCirclePlus: bn,
		MessageCircleQuestion: P2,
		MessageCircleQuestionMark: P2,
		MessageCircleReply: qn,
		MessageCircleWarning: Un,
		MessageCircleX: Tn,
		MessageSquare: he,
		MessageSquareCheck: Zn,
		MessageSquareCode: Gn,
		MessageSquareDashed: Wn,
		MessageSquareDiff: En,
		MessageSquareDot: In,
		MessageSquareHeart: Xn,
		MessageSquareLock: jn,
		MessageSquareMore: Nn,
		MessageSquareOff: Kn,
		MessageSquarePlus: Qn,
		MessageSquareQuote: Jn,
		MessageSquareReply: Yn,
		MessageSquareShare: _n,
		MessageSquareText: xn,
		MessageSquareWarning: ae,
		MessageSquareX: te,
		MessagesSquare: de,
		Metronome: ce,
		Mic: pe,
		...
		MousePointer2Off: Oe,
		MousePointerBan: Ge,
		MousePointerClick: We,
		MousePointerSquareDashed: k0,
		MouseRight: Ie,
		Move: cr,
		Move3D: z2,
		Move3d: z2,
		...
		Paintbrush: Gr,
		Paintbrush2: b2,
		PaintbrushVertical: b2,
		Palette: Wr,
		Palmtree: ea,
		Panda: Er,
		PanelBottom: jr,
		PanelBottomClose: Ir,
		PanelBottomDashed: q2,
		PanelBottomInactive: q2,
		PanelBottomOpen: Xr,
		PanelLeft: Z2,
		PanelLeftClose: T2,
		PanelLeftDashed: U2,
		...
		ReceiptCent: Fv,
		ReceiptEuro: Rv,
		ReceiptIndianRupee: bv,
		ReceiptJapaneseYen: qv,
		ReceiptPoundSterling: Tv,
		ReceiptRussianRuble: Uv,
		ReceiptSwissFranc: Ov,
		ReceiptText: Zv,
		ReceiptTurkishLira: Gv,
		RectangleCircle: Ev,
		RectangleEllipsis: N2,
		RectangleGoggles: Iv,
		RectangleHorizontal: Xv,
		RectangleVertical: jv,
		Recycle: Nv,
		Redo: Qv,
		Redo2: Kv,
		RedoDot: Jv,
		...
		SendHorizontal: _2,
		SendToBack: ym,
		SeparatorHorizontal: gm,
		SeparatorVertical: Cm,
		Server: Vm,
		ServerCog: um,
		ServerCrash: Am,
		ServerOff: Hm,
		...
		Slice: sy,
		Sliders: t0,
		SlidersHorizontal: gy,
		SlidersVertical: t0,
		Smartphone: Ay,
		SmartphoneCharging: Cy,
		SmartphoneNfc: uy,
		Smile: Hy,
		SmilePlus: Vy,
		Snail: wy,
		Snowflake: Sy,
		SoapDispenserDroplet: Ly,
		Sofa: fy,
		SolarPanel: ky,
		SortAsc: S,
		SortDesc: H,
		...
		SplinePointer: Ty,
		Split: Uy,
		SplitSquareHorizontal: Y0,
		SplitSquareVertical: _0,
		Spool: Zy,
		SportShoe: Gy,
		Spotlight: Wy,
		SprayCan: Ey,
		...
		SquareArrowLeft: l0,
		SquareArrowOutDownLeft: i0,
		SquareArrowOutDownRight: n0,
		SquareArrowOutUpLeft: e0,
		SquareArrowOutUpRight: r0,
		SquareArrowRight: o0,
		SquareArrowRightEnter: Xy,
		SquareArrowRightExit: jy,
		SquareArrowUp: $0,
		SquareArrowUpLeft: v0,
		SquareArrowUpRight: m0,
		SquareAsterisk: y0,
		SquareBottomDashedScissors: s0,
		SquareCenterlineDashedHorizontal: g0,
		SquareCenterlineDashedVertical: C0,
		SquareChartGantt: m,
		SquareCheck: A0,
		SquareCheckBig: u0,
		SquareChevronDown: H0,
		SquareChevronLeft: V0,
		SquareChevronRight: w0,
		SquareChevronUp: L0,
		SquareCode: S0,
		SquareDashed: P0,
		SquareDashedBottom: Ky,
		SquareDashedBottomCode: Ny,
		SquareDashedKanban: f0,
		SquareDashedMousePointer: k0,
		SquareDashedText: y,
		SquareDashedTopSolid: Qy,
		SquareDivide: B0,
		SquareDot: z0,
		SquareEqual: D0,
		SquareFunction: F0,
		...
		SquarePower: N0,
		SquareRadical: _y,
		SquareRoundCorner: Yy,
		SquareScissors: K0,
		SquareSigma: Q0,
		SquareSlash: J0,
		SquareSplitHorizontal: Y0,
		SquareSplitVertical: _0,
		SquareSquare: xy,
		SquareStack: as,
		SquareStar: ts,
		SquareStop: hs,
...
lucide.createIcons({icons});\``);
		...
		if (
			(Array.from(c.querySelectorAll(`[${h}]`)).forEach((p) =>
				za(p, { nameAttr: h, icons: t, attrs: d }),
			),
			M &&
			...
			p.length > 0 &&
				...
				Array.from(p).forEach((La) =>
					za(La, { nameAttr: "icon-name", icons: t, attrs: d }),
				));
		}
	};
	(a.AArrowDown = Da),
		...
		(a.AlertTriangle = ra),
		(a.AlignCenter = ca),
		(a.AlignCenterHorizontal = Ia),
		(a.AlignCenterVertical = Xa),
		(a.AlignEndHorizontal = ja),
		(a.AlignEndVertical = Na),
		(a.AlignHorizontalDistributeCenter = Ka),
		(a.AlignHorizontalDistributeEnd = Qa),
		(a.AlignHorizontalDistributeStart = Ja),
		(a.AlignHorizontalJustifyCenter = Ya),
		(a.AlignHorizontalJustifyEnd = _a),
		(a.AlignHorizontalJustifyStart = xa),
		(a.AlignHorizontalSpaceAround = at),
		(a.AlignHorizontalSpaceBetween = tt),
		(a.AlignJustify = pa),
		(a.AlignLeft = s),
		(a.AlignRight = Ma),
		(a.AlignStartHorizontal = ht),
		(a.AlignStartVertical = dt),
		(a.AlignVerticalDistributeCenter = ct),
		(a.AlignVerticalDistributeEnd = Mt),
		(a.AlignVerticalDistributeStart = pt),
		(a.AlignVerticalJustifyCenter = lt),
		(a.AlignVerticalJustifyEnd = it),
		(a.AlignVerticalJustifyStart = nt),
		(a.AlignVerticalSpaceAround = et),
		(a.AlignVerticalSpaceBetween = rt),
		(a.Ambulance = vt),
		(a.Ampersand = ot),
		(a.Ampersands = $t),
		(a.Amphora = mt),
		...
		(a.Armchair = kt),
		(a.ArrowBigDown = zt),
		(a.ArrowBigDownDash = Pt),
		(a.ArrowBigLeft = Dt),
		(a.ArrowBigLeftDash = Bt),
		(a.ArrowBigRight = Rt),
		(a.ArrowBigRightDash = Ft),
		(a.ArrowBigUp = qt),
		(a.ArrowBigUpDash = bt),
		(a.ArrowDown = jt),
		(a.ArrowDown01 = Tt),
		...
		(a.ArrowDownAz = A),
		(a.ArrowDownCircle = Q),
		(a.ArrowDownFromLine = Ot),
		(a.ArrowDownLeft = Zt),
		(a.ArrowDownLeftFromCircle = _),
		(a.ArrowDownLeftFromSquare = i0),
		(a.ArrowDownLeftSquare = c0),
		(a.ArrowDownNarrowWide = Gt),
		(a.ArrowDownRight = Wt),
		(a.ArrowDownRightFromCircle = Y),
		(a.ArrowDownRightFromSquare = n0),
		(a.ArrowDownRightSquare = M0),
		(a.ArrowDownSquare = p0),
		(a.ArrowDownToDot = Et),
		(a.ArrowDownToLine = It),
		(a.ArrowDownUp = Xt),
		...
		(a.ArrowLeft = Jt),
		(a.ArrowLeftCircle = J),
		(a.ArrowLeftFromLine = Kt),
		(a.ArrowLeftRight = Nt),
		(a.ArrowLeftSquare = l0),
		(a.ArrowLeftToLine = Qt),
		(a.ArrowRight = ah),
		(a.ArrowRightCircle = t1),
		(a.ArrowRightFromLine = Yt),
		(a.ArrowRightLeft = _t),
		(a.ArrowRightSquare = o0),
		(a.ArrowRightToLine = xt),
		(a.ArrowUp = eh),
		(a.ArrowUp01 = th),
		(a.ArrowUp10 = hh),
		(a.ArrowUpAZ = w),
		...
		(a.BadgeCent = Vh),
		(a.BadgeCheck = k),
		(a.BadgeDollarSign = wh),
		(a.BadgeEuro = Sh),
		(a.BadgeHelp = P),
		(a.BadgeIndianRupee = Lh),
		(a.BadgeInfo = fh),
		(a.BadgeJapaneseYen = kh),
		(a.BadgeMinus = Ph),
		(a.BadgePercent = Bh),
		(a.BadgePlus = zh),
		(a.BadgePoundSterling = Dh),
		(a.BadgeQuestionMark = P),
		(a.BadgeRussianRuble = Fh),
		(a.BadgeSwissFranc = Rh),
		(a.BadgeTurkishLira = bh),
		(a.BadgeX = qh),
		(a.BaggageClaim = Uh),
		(a.Balloon = Oh),
		(a.Ban = Zh),
		...
		(a.Bandage = Wh),
		(a.Banknote = Nh),
		(a.BanknoteArrowDown = Eh),
		(a.BanknoteArrowUp = Ih),
		(a.BanknoteCheck = Xh),
		(a.BanknoteX = jh),
		(a.BarChart = E),
		(a.BarChart2 = I),
		...
		(a.BarChartHorizontalBig = q),
		(a.Barcode = Kh),
		(a.Barrel = Qh),
		(a.Baseline = Jh),
		(a.Bath = Yh),
		(a.Battery = c4),
		(a.BatteryCharging = _h),
		(a.BatteryFull = xh),
		(a.BatteryLow = a4),
		(a.BatteryMedium = h4),
		(a.BatteryPlus = t4),
		...
		(a.BellPlus = u4),
		(a.BellRing = A4),
		(a.BetweenHorizonalEnd = B),
		(a.BetweenHorizonalStart = z),
		(a.BetweenHorizontalEnd = B),
		(a.BetweenHorizontalStart = z),
		(a.BetweenVerticalEnd = w4),
		(a.BetweenVerticalStart = V4),
		(a.BicepsFlexed = S4),
		(a.Bike = f4),
		(a.Binary = L4),
		(a.Binoculars = k4),
		...
		(a.Blocks = q4),
		(a.Bluetooth = Z4),
		(a.BluetoothConnected = T4),
		(a.BluetoothOff = U4),
		(a.BluetoothSearching = O4),
		(a.Bold = G4),
		(a.Bolt = E4),
		(a.Bomb = W4),
		(a.Bone = X4),
		...
		(a.BrickWall = T5),
		(a.BrickWallFire = b5),
		(a.BrickWallShield = q5),
		(a.Briefcase = G5),
		(a.BriefcaseBusiness = U5),
		(a.BriefcaseConveyorBelt = O5),
		(a.BriefcaseMedical = Z5),
		(a.BringToFront = W5),
		(a.Broccoli = E5),
		(a.Brush = X5),
		(a.BrushCleaning = I5),
		...
		(a.Calendar = S3),
		(a.Calendar1 = M3),
		(a.CalendarArrowDown = p3),
		(a.CalendarArrowUp = l3),
		(a.CalendarCheck = i3),
		(a.CalendarCheck2 = e3),
		(a.CalendarClock = n3),
		(a.CalendarCog = r3),
		...
		(a.ChartBar = T),
		(a.ChartBarBig = q),
		(a.ChartBarDecreasing = J3),
		(a.ChartBarIncreasing = Y3),
		(a.ChartBarStacked = _3),
		(a.ChartCandlestick = U),
		(a.ChartColumn = G),
		(a.ChartColumnBig = O),
		(a.ChartColumnDecreasing = x3),
		(a.ChartColumnIncreasing = Z),
		(a.ChartColumnStacked = ad),
		(a.ChartGantt = td),
		(a.ChartLine = W),
		(a.ChartNetwork = hd),
		(a.ChartNoAxesColumn = I),
		(a.ChartNoAxesColumnDecreasing = dd),
		(a.ChartNoAxesColumnIncreasing = E),
		(a.ChartNoAxesCombined = cd),
		(a.ChartNoAxesGantt = X),
		(a.ChartPie = j),
		(a.ChartScatter = N),
		(a.ChartSpline = Md),
		(a.Check = id),
		...
		(a.ChevronLeftSquare = V0),
		(a.ChevronRight = Ad),
		(a.ChevronRightCircle = l1),
		(a.ChevronRightSquare = w0),
		(a.ChevronUp = Hd),
		(a.ChevronUpCircle = i1),
		(a.ChevronUpSquare = L0),
		(a.ChevronsDown = wd),
		(a.ChevronsDownUp = Vd),
		(a.ChevronsLeft = fd),
		(a.ChevronsLeftRight = Ld),
		(a.ChevronsLeftRightEllipsis = Sd),
		(a.ChevronsRight = Pd),
		(a.ChevronsRightLeft = kd),
		(a.ChevronsUp = zd),
		(a.ChevronsUpDown = Bd),
		(a.Church = Dd),
		(a.Cigarette = Rd),
		...
		(a.CircleArrowDown = Q),
		(a.CircleArrowLeft = J),
		(a.CircleArrowOutDownLeft = _),
		(a.CircleArrowOutDownRight = Y),
		...
		(a.CircleChevronRight = l1),
		(a.CircleChevronUp = i1),
		(a.CircleDashed = bd),
		(a.CircleDivide = n1),
		(a.CircleDollarSign = qd),
		(a.CircleDot = Ud),
		(a.CircleDotDashed = Td),
		(a.CircleEllipsis = Od),
		(a.CircleEqual = Zd),
		(a.CircleEuroSign = Gd),
		(a.CircleFadingArrowUp = Wd),
		(a.CircleFadingPlus = Ed),
		(a.CircleGauge = e1),
		(a.CircleHelp = n),
		(a.CircleMinus = r1),
		(a.CircleOff = Id),
		...
		(a.ClipboardPaste = M6),
		(a.ClipboardPen = S1),
		(a.ClipboardPenLine = w1),
		(a.ClipboardPlus = p6),
		(a.ClipboardSignature = w1),
		(a.ClipboardType = l6),
		(a.ClipboardX = i6),
		(a.Clock = B6),
		(a.Clock1 = e6),
		...
		(a.Copyright = w8),
		(a.CornerDownLeft = S8),
		(a.CornerDownRight = L8),
		(a.CornerLeftDown = f8),
		(a.CornerLeftUp = k8),
		(a.CornerRightDown = P8),
		(a.CornerRightUp = B8),
		(a.CornerUpLeft = z8),
		(a.CornerUpRight = F8),
		(a.Cpu = D8),
		(a.CreativeCommons = R8),
		(a.CreditCard = b8),
		(a.Croissant = q8),
		(a.Crop = T8),
		(a.Cross = U8),
		...
		(a.Dam = X8),
		(a.Database = tc),
		(a.DatabaseArrowDown = j8),
		(a.DatabaseArrowUp = N8),
		(a.DatabaseBackup = K8),
		(a.DatabaseCheck = Q8),
		(a.DatabaseMinus = J8),
		(a.DatabasePlus = Y8),
		...
		(a.DatabaseX = x8),
		(a.DatabaseZap = ac),
		(a.DecimalsArrowLeft = cc),
		(a.DecimalsArrowRight = hc),
		(a.Delete = dc),
		(a.Dessert = Mc),
		(a.Diameter = pc),
		(a.Diamond = nc),
		...
		(a.Donut = kc),
		(a.DoorClosed = Bc),
		(a.DoorClosedLocked = Pc),
		(a.DoorOpen = zc),
		(a.Dot = Fc),
		(a.DotSquare = z0),
		(a.Download = Dc),
		(a.DownloadCloud = L1),
		(a.DraftingCompass = Rc),
		(a.Drama = bc),
		(a.Drill = qc),
		(a.Drone = Tc),
		(a.Droplet = Oc),
		...
		(a.Ellipse = Jc),
		(a.Ellipsis = b1),
		(a.EllipsisVertical = R1),
		(a.Equal = xc),
		(a.EqualApproximately = _c),
		(a.EqualNot = a7),
		(a.EqualSquare = D0),
		(a.Eraser = h7),
		(a.EthernetPort = t7),
		...
		(a.FilterX = e2),
		(a.Fingerprint = l2),
		(a.FingerprintPattern = l2),
		(a.FireExtinguisher = K7),
		(a.Fish = Y7),
		(a.FishOff = Q7),
		(a.FishSymbol = J7),
		(a.FishingHook = _7),
		...
		(a.Flag = d9),
		(a.FlagOff = a9),
		(a.FlagTriangleLeft = t9),
		(a.FlagTriangleRight = h9),
		(a.Flame = M9),
		(a.FlameKindling = c9),
		(a.Flashlight = l9),
		(a.FlashlightOff = p9),
		(a.FlaskConical = i9),
		(a.FlaskConicalOff = n9),
		(a.FlaskRound = e9),
		(a.FlipHorizontal = g0),
		(a.FlipHorizontal2 = r9),
		(a.FlipVertical = C0),
		(a.FlipVertical2 = o9),
		(a.Flower = $9),
		(a.Flower2 = v9),
		...
		(a.FunnelPlus = tM),
		(a.FunnelX = e2),
		(a.GalleryHorizontal = cM),
		(a.GalleryHorizontalEnd = dM),
		(a.GalleryThumbnails = MM),
		(a.GalleryVertical = lM),
		(a.GalleryVerticalEnd = pM),
		(a.Gamepad = eM),
		(a.Gamepad2 = iM),
		(a.GamepadDirectional = nM),
		(a.GanttChart = X),
		...
		(a.GitCommitVertical = uM),
		(a.GitCompare = HM),
		(a.GitCompareArrows = AM),
		(a.GitFork = VM),
		(a.GitGraph = wM),
		(a.GitMerge = SM),
		(a.GitMergeConflict = LM),
		(a.GitPullRequest = DM),
		(a.GitPullRequestArrow = fM),
		(a.GitPullRequestClosed = kM),
		(a.GitPullRequestCreate = BM),
		(a.GitPullRequestCreateArrow = PM),
		(a.GitPullRequestDraft = zM),
		(a.GlassWater = FM),
		(a.Glasses = RM),
		(a.Globe = ZM),
		(a.Globe2 = F1),
		...
		(a.Handshake = Mp),
		(a.HardDrive = np),
		(a.HardDriveDownload = lp),
		(a.HardDriveUpload = ip),
		(a.HardHat = ep),
		(a.Hash = rp),
		(a.HatGlasses = op),
		(a.Haze = vp),
		...
		(a.LayersPlus = Zl),
		(a.Layout = E2),
		(a.LayoutDashboard = Gl),
		(a.LayoutGrid = Wl),
		(a.LayoutList = El),
		(a.LayoutPanelLeft = Il),
		(a.LayoutPanelTop = Xl),
		(a.LayoutTemplate = jl),
		(a.Leaf = Nl),
		(a.LeafyGreen = Kl),
		...
		(a.ListCheck = ei),
		(a.ListChecks = ri),
		(a.ListChevronsDownUp = oi),
		(a.ListChevronsUpDown = vi),
		(a.ListCollapse = $i),
		(a.ListEnd = mi),
		(a.ListFilter = si),
		(a.ListFilterPlus = yi),
		...
		(a.ListPlus = Ai),
		(a.ListRestart = Hi),
		(a.ListSortAscending = Vi),
		(a.ListSortDescending = Si),
		(a.ListStart = wi),
		(a.ListTodo = Li),
		(a.ListTree = fi),
		(a.ListVideo = ki),
		...
		(a.Merge = kn),
		(a.MessageCircle = On),
		(a.MessageCircleCheck = Pn),
		(a.MessageCircleCode = Bn),
		(a.MessageCircleDashed = zn),
		(a.MessageCircleHeart = Dn),
		(a.MessageCircleMore = Fn),
		(a.MessageCircleOff = Rn),
		(a.MessageCirclePlus = bn),
		(a.MessageCircleQuestion = P2),
		(a.MessageCircleQuestionMark = P2),
		(a.MessageCircleReply = qn),
		(a.MessageCircleWarning = Un),
		(a.MessageCircleX = Tn),
		(a.MessageSquare = he),
		(a.MessageSquareCheck = Zn),
		(a.MessageSquareCode = Gn),
		(a.MessageSquareDashed = Wn),
		(a.MessageSquareDiff = En),
		(a.MessageSquareDot = In),
		(a.MessageSquareHeart = Xn),
		(a.MessageSquareLock = jn),
		(a.MessageSquareMore = Nn),
		(a.MessageSquareOff = Kn),
		(a.MessageSquarePlus = Qn),
		(a.MessageSquareQuote = Jn),
		(a.MessageSquareReply = Yn),
		(a.MessageSquareShare = _n),
		(a.MessageSquareText = xn),
		(a.MessageSquareWarning = ae),
		(a.MessageSquareX = te),
		(a.MessagesSquare = de),
		(a.Metronome = ce),
		(a.Mic = pe),
		...
		(a.MousePointer = Ee),
		(a.MousePointer2 = Ze),
		(a.MousePointer2Off = Oe),
		(a.MousePointerBan = Ge),
		(a.MousePointerClick = We),
		(a.MousePointerSquareDashed = k0),
		(a.MouseRight = Ie),
		(a.Move = cr),
		(a.Move3D = z2),
		(a.Move3d = z2),
		...
		(a.Paintbrush = Gr),
		(a.Paintbrush2 = b2),
		(a.PaintbrushVertical = b2),
		(a.Palette = Wr),
		(a.Palmtree = ea),
		(a.Panda = Er),
		(a.PanelBottom = jr),
		(a.PanelBottomClose = Ir),
		(a.PanelBottomDashed = q2),
		(a.PanelBottomInactive = q2),
		(a.PanelBottomOpen = Xr),
		(a.PanelLeft = Z2),
		(a.PanelLeftClose = T2),
		(a.PanelLeftDashed = U2),
		(a.PanelLeftInactive = U2),
		(a.PanelLeftOpen = O2),
		(a.PanelLeftRightDashed = Nr),
		(a.PanelRight = Jr),
		(a.PanelRightClose = Kr),
		(a.PanelRightDashed = G2),
		(a.PanelRightInactive = G2),
		(a.PanelRightOpen = Qr),
		(a.PanelTop = ao),
		(a.PanelTopBottomDashed = Yr),
		(a.PanelTopClose = _r),
		(a.PanelTopDashed = W2),
		(a.PanelTopInactive = W2),
		(a.PanelTopOpen = xr),
		(a.PanelsLeftBottom = to),
		(a.PanelsLeftRight = B1),
		(a.PanelsRightBottom = ho),
		...
		(a.Piano = Fo),
		(a.Pickaxe = Ro),
		(a.PictureInPicture = qo),
		(a.PictureInPicture2 = bo),
		(a.PieChart = j),
		(a.PiggyBank = To),
		(a.Pilcrow = Zo),
		(a.PilcrowLeft = Uo),
		...
		(a.ReceiptCent = Fv),
		(a.ReceiptEuro = Rv),
		(a.ReceiptIndianRupee = bv),
		(a.ReceiptJapaneseYen = qv),
		(a.ReceiptPoundSterling = Tv),
		(a.ReceiptRussianRuble = Uv),
		(a.ReceiptSwissFranc = Ov),
		(a.ReceiptText = Zv),
		(a.ReceiptTurkishLira = Gv),
		(a.RectangleCircle = Ev),
		(a.RectangleEllipsis = N2),
		(a.RectangleGoggles = Iv),
		(a.RectangleHorizontal = Xv),
		(a.RectangleVertical = jv),
		(a.Recycle = Nv),
		(a.Redo = Qv),
		(a.Redo2 = Kv),
		(a.RedoDot = Jv),
		...
		(a.SendHorizontal = _2),
		(a.SendToBack = ym),
		(a.SeparatorHorizontal = gm),
		(a.SeparatorVertical = Cm),
		(a.Server = Vm),
		(a.ServerCog = um),
		(a.ServerCrash = Am),
		(a.ServerOff = Hm),
		...
		(a.Slice = sy),
		(a.Sliders = t0),
		(a.SlidersHorizontal = gy),
		(a.SlidersVertical = t0),
		(a.Smartphone = Ay),
		(a.SmartphoneCharging = Cy),
		(a.SmartphoneNfc = uy),
		(a.Smile = Hy),
		(a.SmilePlus = Vy),
		(a.Snail = wy),
		(a.Snowflake = Sy),
		(a.SoapDispenserDroplet = Ly),
		(a.Sofa = fy),
		(a.SolarPanel = ky),
		(a.SortAsc = S),
		(a.SortDesc = H),
		...
		(a.SplinePointer = Ty),
		(a.Split = Uy),
		(a.SplitSquareHorizontal = Y0),
		(a.SplitSquareVertical = _0),
		(a.Spool = Zy),
		(a.SportShoe = Gy),
		(a.Spotlight = Wy),
		(a.SprayCan = Ey),
		...
		(a.SquareArrowLeft = l0),
		(a.SquareArrowOutDownLeft = i0),
		(a.SquareArrowOutDownRight = n0),
		(a.SquareArrowOutUpLeft = e0),
		(a.SquareArrowOutUpRight = r0),
		(a.SquareArrowRight = o0),
		(a.SquareArrowRightEnter = Xy),
		(a.SquareArrowRightExit = jy),
		(a.SquareArrowUp = $0),
		(a.SquareArrowUpLeft = v0),
		(a.SquareArrowUpRight = m0),
		(a.SquareAsterisk = y0),
		(a.SquareBottomDashedScissors = s0),
		(a.SquareCenterlineDashedHorizontal = g0),
		(a.SquareCenterlineDashedVertical = C0),
		(a.SquareChartGantt = m),
		(a.SquareCheck = A0),
		(a.SquareCheckBig = u0),
		(a.SquareChevronDown = H0),
		(a.SquareChevronLeft = V0),
		(a.SquareChevronRight = w0),
		(a.SquareChevronUp = L0),
		(a.SquareCode = S0),
		(a.SquareDashed = P0),
		(a.SquareDashedBottom = Ky),
		(a.SquareDashedBottomCode = Ny),
		(a.SquareDashedKanban = f0),
		(a.SquareDashedMousePointer = k0),
		(a.SquareDashedText = y),
		(a.SquareDashedTopSolid = Qy),
		(a.SquareDivide = B0),
		(a.SquareDot = z0),
		(a.SquareEqual = D0),
		(a.SquareFunction = F0),
		...
		(a.SquareMenu = T0),
		(a.SquareMinus = U0),
		(a.SquareMousePointer = Z0),
		(a.SquareParking = G0),
		(a.SquareParkingOff = O0),
		(a.SquarePause = Jy),
		(a.SquarePen = l),
		(a.SquarePercent = W0),
		(a.SquarePi = E0),
		...
		(a.SquarePower = N0),
		(a.SquareRadical = _y),
		(a.SquareRoundCorner = Yy),
		(a.SquareScissors = K0),
		(a.SquareSigma = Q0),
		(a.SquareSlash = J0),
		(a.SquareSplitHorizontal = Y0),
		(a.SquareSplitVertical = _0),
		(a.SquareSquare = xy),
		(a.SquareStack = as),
		(a.SquareStar = ts),
		(a.SquareStop = hs),
		(a.SquareTerminal = x0),
		(a.SquareUser = aa),
		(a.SquareUserRound = ta),
		(a.SquareX = ha),
		(a.SquaresExclude = ds),
		(a.SquaresIntersect = Ms),
		(a.SquaresSubtract = ps),
		(a.SquaresUnite = ls),
		(a.Squircle = ns),
		(a.SquircleDashed = is),
		(a.Squirrel = rs),
		...
		(a.Sticker = Hs),
		(a.StickyNote = ks),
		(a.StickyNoteCheck = Vs),
		(a.StickyNoteMinus = ws),
		(a.StickyNoteOff = Ss),
		(a.StickyNotePlus = fs),
		(a.StickyNoteX = Ls),
		(a.StickyNotes = Ps),
		...
		(a.StopCircle = u1),
		(a.Store = zs),
		(a.StretchHorizontal = Ds),
		(a.StretchVertical = bs),
		(a.Strikethrough = Fs),
		(a.Subscript = Rs),
		(a.Subtitles = R),
		(a.Summary = qs),
		...
		(a.Table = cg),
		(a.Table2 = Ys),
		(a.TableCellsMerge = _s),
		(a.TableCellsSplit = xs),
		(a.TableColumnsSplit = ag),
		(a.TableConfig = e),
		(a.TableOfContents = tg),
		(a.TableProperties = hg),
		(a.TableRowsSplit = dg),
		(a.Tablet = pg),
		(a.TabletSmartphone = Mg),
		(a.Tablets = lg),
		(a.Tag = ng),
		(a.TagPlus = ig),
		(a.TagX = eg),
		...
		(a.TestTube = Vg),
		(a.TestTube2 = da),
		(a.TestTubeDiagonal = da),
		(a.TestTubes = wg),
		(a.Text = s),
		(a.TextAlignCenter = ca),
		(a.TextAlignEnd = Ma),
		(a.TextAlignJustify = pa),
		(a.TextAlignStart = s),
		(a.TextCursor = Lg),
		(a.TextCursorInput = Sg),
		(a.TextInitial = la),
		(a.TextQuote = fg),
		(a.TextSearch = kg),
		(a.TextSelect = y),
		...
		(a.ZodiacAries = uA),
		(a.ZodiacCancer = AA),
		(a.ZodiacCapricorn = HA),
		(a.ZodiacGemini = VA),
		(a.ZodiacLeo = wA),
		(a.ZodiacLibra = SA),
		(a.ZodiacOphiuchus = LA),
		(a.ZodiacPisces = fA),
		(a.ZodiacSagittarius = kA),
		(a.ZodiacScorpio = PA),
		(a.ZodiacTaurus = BA),
		(a.ZodiacVirgo = zA),
		(a.ZoomIn = DA),
