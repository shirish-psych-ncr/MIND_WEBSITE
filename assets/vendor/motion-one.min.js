!((t, e) => {
	...
	function nt(t, n, i, a = {}, c) {
		...
		const L = J(n),
			W = ((t, e) => (t.has(e) || t.set(e, new D()), t.get(e)))(M.values, L),
			R = B.get(L);
		return (
		...
		const o = rt(t),
			...
			a = new IntersectionObserver(
				...
				},
				{
					root: n,
					rootMargin: i,
					threshold: "number" === typeof r ? r : Dt[r],
				},
			);
	...
	(t.MotionValue = D),
		(t.ScrollOffset = Ft),
		(t.animate = (t, e, n) => (y(t) ? me : ft)(t, e, n)),
		(t.animateStyle = nt),
		(t.createAnimate = ut),
