const _htmx = (() => {
	...
	const R = v.map((e) => `[hx-${e}], [data-hx-${e}]`).join(", ");
	const O = e("head");
	...
	function Ee(e, t) {
		return ce(T(e, (e) => te(ce(e), t) != null));
	}
	function Ce(e) {
	...
	function qe(e) {
		se(p(e, "[hx-preserve], [data-hx-preserve]"), (e) => {
			const t = te(e, "id");
	...
	function $e(e, n) {
		se(p(e, "[hx-swap-oob], [data-hx-swap-oob]"), (e) => {
	...
	function ze(e, t, r, o) {
		...
		if (r.swapStyle === "textContent") {
			...
			se(p(n, "template"), (e) => {
				$e(e.content, s);
				if (
					e.content.childElementCount === 0 &&
					e.content.textContent.trim() === ""
				) {
					e.remove();
				}
			});
	...
	function sn(t, n, r, o, i) {
		...
		if (nn(o)) {
			...
			if (o instanceof HTMLSelectElement && o.multiple) {
				e = F(o.querySelectorAll("option:checked")).map((e) => e.value);
			}
