...
!((n, e) => {
	...
	var w = {
		...
		obj: (n) => u(Object.prototype.toString.call(n), "Object"),
		pth: (n) => w.obj(n) && Object.hasOwn(n, "totalLength"),
		svg: (n) => n instanceof SVGElement,
		inp: (n) => n instanceof HTMLInputElement,
		dom: (n) => n.nodeType || w.svg(n),
		str: (n) => "string" === typeof n,
		fnc: (n) => "function" === typeof n,
		und: (n) => void 0 === n,
		nil: (n) => w.und(n) || null === n,
		hex: (n) => /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(n),
		rgb: (n) => /^rgb/.test(n),
		hsl: (n) => /^hsl/.test(n),
		col: (n) => w.hex(n) || w.rgb(n) || w.hsl(n),
		key: (n) =>
			!Object.hasOwn(i, n) &&
			!Object.hasOwn(M, n) &&
			"targets" !== n &&
	...
	function d(n) {
		n = /\(([^)]+)\)/.exec(n);
		return n ? n[1].split(",").map((n) => parseFloat(n)) : [];
	}
	function c(r, t) {
		var n = d(r),
			_e = C(w.und(n[0]) ? 1 : n[0], 0.1, 100),
	...
	function q(e) {
		return (
			void 0 === e && (e = 10), (n) => Math.ceil(C(n, 1e-6, 1) * e) * (1 / e)
		);
	}
	const H = (b, e, M, t) => {
		if (0 <= b && b <= 1 && 0 <= M && M <= 1) {
			...
			if (b !== e || M !== t)
				for (let n = 0; n < 11; ++n) x[n] = k(0.1 * n, b, M);
			return (n) =>
				(b === e && M === t) || 0 === n || 1 === n ? n : k(r(n), e, t);
		}
		function r(n) {
			for (var e = 0, t = 1; 10 !== t && x[t] <= n; ++t) e += 0.1;
			const r = e + 0.1 * ((n - x[--t]) / (x[t + 1] - x[t])),
				a = O(r, b, M);
			if (0.001 <= a) {
	...
	(e = { linear: () => (n) => n }),
		(t = {
			...
			Expo: () => (n) => (n ? 2 ** (10 * n - 10) : 0),
			Circ: () => (n) => 1 - Math.sqrt(1 - n * n),
			Back: () => (n) => n * n * (3 * n - 2),
			Bounce: () => (n) => {
				for (var e, t = 4; n < ((e = 2 ** --t) - 1) / 11; );
				return 1 / 4 ** (3 - t) - 7.5625 * ((3 * e - 2) / 22 - n) ** 2;
			},
			Elastic: (n, e) => {
				void 0 === e && (e = 0.5);
				const t = C((n = void 0 === n ? 1 : n), 1, 10),
					r = C(e, 0.1, 2);
				return (n) =>
					0 === n || 1 === n
						? n
		...
		["Quad", "Cubic", "Quart", "Quint"].forEach((n, e) => {
			t[n] = () => (n) => n ** (e + 2);
		}),
		Object.keys(t).forEach((n) => {
			const r = t[n];
			(e[`easeIn${n}`] = r),
				(e[`easeOut${n}`] = (e, t) => (n) => 1 - r(e, t)(1 - n)),
				(e[`easeInOut${n}`] = (e, t) => (n) =>
					n < 0.5 ? r(e, t)(2 * n) / 2 : 1 - r(e, t)(-2 * n + 2) / 2),
				(e[`easeOutIn${n}`] = (e, t) => (n) =>
					n < 0.5
						? (1 - r(e, t)(1 - 2 * n)) / 2
						: (r(e, t)(2 * n - 1) + 1) / 2);
	...
	function f(n) {
		return n.reduce((n, e) => n.concat(w.arr(e) ? f(e) : e), []);
	}
	function p(n) {
		return w.arr(n)
			? n
	...
	function x(n, e) {
		let t,
			r = g(n);
		for (t in n) r[t] = (Object.hasOwn(e, t) ? e : n)[t];
		return r;
	}
	function D(n, e) {
		let t,
	...
	function F(n, e) {
		return Math.sqrt((e.x - n.x) ** 2 + (e.y - n.y) ** 2);
	}
	function Z(n) {
	...
	function R(e) {
		for (
			var t = I(f(e.map((n) => Object.keys(n))), (n) => w.key(n)).reduce(
					(n, e) => (n.indexOf(e) < 0 && n.push(e), n),
					[],
				),
				a = {},
				n = 0;
	...
	function K(i, c) {
		let s;
		return i.tweens.map((_n) => {
			var n = ((n, e) => {
					let t,
						r = {};
					for (t in n) {
						let a = m(n[t], e);
						w.arr(a) && 1 === (a = a.map((n) => m(n, e))).length && (a = a[0]),
							(r[t] = a);
					}
					return (
	...
	const U = {
		css: (n, e, t) => (n.style[e] = t),
		attribute: (n, e, t) => n.setAttribute(e, t),
		object: (n, e, t) => (n[e] = t),
		transform: (n, e, t, r, a) => {
			let o;
			r.list.set(e, t),
		...
		return (
			...
			(a.endDelay = r
				? a.duration -
					Math.max.apply(
						Math,
						n.map((n) => t(n) + n.duration - n.endDelay),
					)
				: e.endDelay),
			a
		);
				...
				document.addEventListener("visibilitychange", () => {
					L.suspendWhenDocumentHidden &&
						(n()
							...
							: (S.forEach((n) => n._onDocumentVisibility()), an()));
				}),
			() => {
	...
	function L(n) {
		let c,
			...
			p = null;
		function _h(n) {
			const e = window.Promise && new Promise((n) => (p = n));
			return (n.finished = e);
		}
		...
		function g() {
			...
			"alternate" !== n &&
				...
				c.forEach((n) => (n.reversed = k.reversed));
		}
		function m(n) {
		...
		function v(n, e) {
			e?.seek(n - e.timelineOffset);
		}
		function y(e) {
			for (let n = 0, t = k.animations, r = t.length; n < r; ) {
				for (
					var a = t[n],
						o = a.animatable,
						u = a.tweens,
						...
						c = u[i],
						i =
							(i && (c = I(u, (n) => e < n.end)[0] || c),
							C(e - c.start - c.delay, 0, c.duration) / c.duration),
						s = Number.isNaN(i) ? 1 : c.easing(i),
						f = c.to.strings,
						l = c.round,
						d = [],
		...
		function u(n) {
			...
			if (
				...
				const o = a;
				if (k.reversePlayback) for (let u = d; u--; ) v(o, c[u]);
				else for (let i = 0; i < d; i++) v(o, c[i]);
			}
		...
		return (
			(k.reset = () => {
				...
				(k.passThrough = !1),
					...
					(k.remaining = k.loop),
					(c = k.children);
				for (let e = (d = c.length); e--; ) k.children[e].reset();
				((k.reversed && !0 !== k.loop) ||
	...
	return (
		...
		(L.running = S),
		(L.remove = (n) => {
			for (let e = A(n), t = S.length; t--; ) cn(e, S[t]);
		}),
		(L.get = T),
		(L.set = nn),
		(L.convertPx = y),
		(L.path = (n, e) => {
			const t = w.str(n) ? a(n)[0] : n,
				r = e || 100;
			return (n) => ({
				property: n,
				el: t,
		...
		(L.stagger = (n, e) => {
			let i = (e = void 0 === e ? {} : e).direction || "normal",
			...
			return (_n, e, t) => {
				if (
					...
					c && (M = M.map((n) => c(n / x) * x)),
						"reverse" === i &&
							(M = M.map((n) => (f ? (n < 0 ? -1 * n : -n) : Math.abs(x - n))));
				}
				return b + (g ? (v - m) / x : m) * (Math.round(100 * M[e]) / 100) + y;
			};
		}),
		(L.timeline = (u) => {
			const i = L((u = void 0 === u ? {} : u));
			return (
				(i.duration = 0),
				(i.add = (n, e) => {
					let t = S.indexOf(i),
					...
					-1 < t && S.splice(t, 1);
					for (let o = 0; o < r.length; o++) a(r[o]);
					(t = D(n, x(M, u))),
		...
		(L.easing = P),
		(L.penner = s),
		(L.random = (n, e) => Math.floor(Math.random() * (e - n + 1)) + n),
		L
	);
});
