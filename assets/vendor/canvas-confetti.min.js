...
!((t, e) => {
	!(function t(e, a, n, r) {
		...
		let h,
			...
			w =
				...
				(f = new Map()),
				{
					transform: (t) => {
						...
						const e = new OffscreenCanvas(t.width, t.height);
			...
			x =
				...
				"function" === typeof cancelAnimationFrame
					...
					: ((u = (t) => setTimeout(t, m)), (d = (t) => clearTimeout(t))),
				{ frame: u, cancel: d }),
			C =
				((v = {}),
				() => {
						...
						!((t) => {
							...
							(t.init = (e) => {
								...
								(t.fire = (a, _n, r) => {
									...
									const o = Math.random().toString(36).slice(2);
									return (M = c((n) => {
										function i(e) {
											e.data.callback === o &&
												(delete v[o],
								...
								(t.reset = () => {
									for (const e in (t.postMessage({ reset: !0 }), v))
										v[e](), delete v[e];
								});
						})(b);
					}
		...
		function T(t, e, a) {
			return ((t, e) => (e ? e(t) : t))(t && null != t[e] ? t[e] : I[e], a);
		}
		function E(t) {
		...
		function F(t, e) {
			...
			if (
				...
				const m = t.createPattern(w.transform(e.shape.bitmap), "no-repeat");
				m.setTransform(d),
					(t.globalAlpha = 1 - a),
					(t.fillStyle = m),
		...
		function A(t, a) {
			...
			function b(a) {
				const n = f || T(a, "disableForReducedMotion", Boolean),
					r = T(a, "zIndex", Number);
				if (n && g)
					return c((t) => {
						t();
				...
				l && i
					...
					s && !m && d(t);
				const o = { width: t.width, height: t.height };
				function b() {
					if (u) {
						const e = {
