...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function revealForm() {
    ...
    announceToScreenReader(
      "Booking form is now visible. Please fill out the secure form below.",
    );
    ...
    requestAnimationFrame(() => {
      const firstFocusable = formSection.querySelector(
  ...
  if (iframe) {
    ...
    iframe.addEventListener("error", () => {
      ...
      if (wrapper) {
        ...
        announceToScreenReader(
          "There was an issue loading the booking form. Please try refreshing the page or contact us directly.",
        );
      }
    });
  }
