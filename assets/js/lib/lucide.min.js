...
((a, n) => {
	...
	const Q$ = (t) =>
		...
		_$ = (t) =>
			t.replace(
				/(\w)(\w*)(_|-|\s*)/g,
				(_d, c, p) => c.toUpperCase() + p.toLowerCase(),
			),
		E0 = (t, { nameAttr: d, icons: c, attrs: p }) => {
			...
			const N$ = Q$(t),
				[hm, tm, dm] = X$,
				K$ = { ...tm, "data-lucide": M, ...p, ...N$ },
				J$ = Y$(["lucide", `lucide-${M}`, N$, p]);
			J$ && Object.assign(K$, { class: J$ });
			const cm = I0([hm, K$, dm]);
			return t.parentNode?.replaceChild(cm, t);
		},
		h = {
		...
		Wa = ["svg", h, [["path", { d: "M15 6v6h4l-7 7-7-7h4V6h6z" }]]],
		Xa = [
			"svg",
			h,
			[
		...
		Na = ["svg", h, [["path", { d: "M18 15h-6v4l-7-7 7-7v4h6v6z" }]]],
		Ka = [
			"svg",
			h,
			[
		...
		Ja = ["svg", h, [["path", { d: "M6 9h6V5l7 7-7 7v-4H6V9z" }]]],
		Qa = [
			"svg",
			h,
			[
		...
		ja = ["svg", h, [["path", { d: "M9 18v-6H5l7-7 7 7h-4v6H9z" }]]],
		Ya = [
			"svg",
			h,
			[
		...
		Et = ["svg", h, [["path", { d: "m7 7 10 10-5 5V2l5 5L7 17" }]]],
		xt = [
			"svg",
			h,
			[
		...
		J5 = ["svg", h, [["path", { d: "M20 6 9 17l-5-5" }]]],
		Q5 = [
			"svg",
			h,
			[
		...
		hd = ["svg", h, [["path", { d: "m15 18-6-6 6-6" }]]],
		td = ["svg", h, [["path", { d: "m9 18 6-6-6-6" }]]],
		dd = ["svg", h, [["path", { d: "m18 15-6-6-6 6" }]]],
		cd = [
			"svg",
			h,
			[
		...
		fd = ["svg", h, [["circle", { cx: "12", cy: "12", r: "10" }]]],
		Pd = [
			"svg",
			h,
			[
		...
		W6 = ["svg", h, [["circle", { cx: "12.1", cy: "12.1", r: "1" }]]],
		X6 = [
			"svg",
			h,
			[
		...
		R8 = ["svg", h, [["path", { d: "M2 16s9-15 20-4C11 23 2 8 2 8" }]]],
		z8 = [
			"svg",
			h,
			[
		...
		T8 = ["svg", h, [["path", { d: "M17 22V2L7 7l10 5" }]]],
		Z8 = ["svg", h, [["path", { d: "M7 22V2l10 5-10 5" }]]],
		b8 = [
			"svg",
			h,
			[
		...
		j1 = ["svg", h, [["path", { d: "M21 12a9 9 0 1 1-6.219-8.56" }]]],
		Ge = [
			"svg",
			h,
			[
		...
		Wn = ["svg", h, [["path", { d: "M7.9 20A9 9 0 1 0 4 16.1L2 22Z" }]]],
		Xn = [
			"svg",
			h,
			[
		...
		z9 = ["svg", h, [["path", { d: "M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z" }]]],
		q9 = [
			"svg",
			h,
			[
		...
		T9 = ["svg", h, [["path", { d: "m8 3 4 8 5-5 5 15H2L8 3z" }]]],
		Z9 = [
			"svg",
			h,
			[
		...
		ei = ["svg", h, [["polygon", { points: "12 2 19 21 12 17 5 21 12 2" }]]],
		ni = [
			"svg",
			h,
			[
		...
		ii = ["svg", h, [["polygon", { points: "3 11 22 2 13 21 11 13 3 11" }]]],
		li = [
			"svg",
			h,
			[
		...
		bl = ["svg", h, [["polygon", { points: "6 3 20 12 6 21 6 3" }]]],
		Ul = [
			"svg",
			h,
			[
	...
	const W$ = Object.freeze({
		...
		AlertTriangle: P0,
		AlignCenter: da,
		AlignCenterHorizontal: ha,
		AlignCenterVertical: ta,
		AlignEndHorizontal: ca,
		AlignEndVertical: Ma,
		AlignHorizontalDistributeCenter: pa,
		AlignHorizontalDistributeEnd: ea,
		AlignHorizontalDistributeStart: na,
		AlignHorizontalJustifyCenter: ia,
		AlignHorizontalJustifyEnd: la,
		AlignHorizontalJustifyStart: va,
		AlignHorizontalSpaceAround: oa,
		AlignHorizontalSpaceBetween: sa,
		AlignJustify: ra,
		AlignLeft: ga,
		AlignRight: ya,
		AlignStartHorizontal: $a,
		AlignStartVertical: ma,
		AlignVerticalDistributeCenter: Ca,
		AlignVerticalDistributeEnd: ua,
		AlignVerticalDistributeStart: Ha,
		AlignVerticalJustifyCenter: wa,
		AlignVerticalJustifyEnd: Va,
		AlignVerticalJustifyStart: Aa,
		AlignVerticalSpaceAround: Sa,
		AlignVerticalSpaceBetween: La,
		Ambulance: fa,
		Ampersand: Pa,
		Ampersands: ka,
		Amphora: Ba,
		...
		ArrowDownAz: g,
		ArrowDownCircle: I,
		ArrowDownFromLine: ah,
		ArrowDownLeft: hh,
		ArrowDownLeftFromCircle: x,
		ArrowDownLeftFromSquare: F2,
		ArrowDownLeftSquare: f2,
		ArrowDownNarrowWide: th,
		ArrowDownRight: dh,
		ArrowDownRightFromCircle: W,
		ArrowDownRightFromSquare: D2,
		ArrowDownRightSquare: P2,
		ArrowDownSquare: k2,
		ArrowDownToDot: ch,
		ArrowDownToLine: Mh,
		ArrowDownUp: ph,
		...
		ArrowLeft: vh,
		ArrowLeftCircle: E,
		ArrowLeftFromLine: nh,
		ArrowLeftRight: ih,
		ArrowLeftSquare: B2,
		ArrowLeftToLine: lh,
		ArrowRight: gh,
		ArrowRightCircle: K,
		ArrowRightFromLine: oh,
		ArrowRightLeft: sh,
		ArrowRightSquare: q2,
		ArrowRightToLine: rh,
		ArrowUp: Sh,
		...
		ArrowUpLeftFromSquare: R2,
		ArrowUpLeftSquare: T2,
		ArrowUpNarrowWide: C,
		ArrowUpRight: wh,
		ArrowUpRightFromCircle: N,
		ArrowUpRightFromSquare: z2,
		ArrowUpRightSquare: Z2,
		ArrowUpSquare: b2,
		ArrowUpToLine: Vh,
		ArrowUpWideNarrow: Ah,
		ArrowUpZA: u,
		ArrowUpZa: u,
		ArrowsUpFromLine: Lh,
		Asterisk: fh,
		...
		BadgePercent: Wh,
		BadgePlus: Xh,
		BadgePoundSterling: Nh,
		BadgeRussianRuble: Kh,
		BadgeSwissFranc: Jh,
		BadgeX: Qh,
		BaggageClaim: Yh,
		Ban: _h,
		...
		Blocks: Ut,
		Bluetooth: Et,
		BluetoothConnected: Ot,
		BluetoothOff: Gt,
		BluetoothSearching: It,
		Bold: xt,
		Bolt: Wt,
		Bomb: Xt,
		Bone: Nt,
		...
		ChartBar: B,
		ChartBarBig: k,
		ChartBarDecreasing: b5,
		ChartBarIncreasing: U5,
		ChartBarStacked: O5,
		ChartCandlestick: F,
		ChartColumn: z,
		ChartColumnBig: D,
		ChartColumnDecreasing: G5,
		ChartColumnIncreasing: R,
		ChartColumnStacked: I5,
		ChartGantt: E5,
		ChartLine: q,
		ChartNetwork: x5,
		ChartNoAxesColumn: Z,
		ChartNoAxesColumnDecreasing: W5,
		ChartNoAxesColumnIncreasing: T,
		ChartNoAxesCombined: X5,
		ChartNoAxesGantt: b,
		ChartPie: U,
		ChartScatter: O,
		ChartSpline: N5,
		...
		ChevronsDownUp: cd,
		ChevronsLeft: nd,
		ChevronsLeftRight: ed,
		ChevronsLeftRightEllipsis: pd,
		ChevronsRight: ld,
		ChevronsRightLeft: id,
		ChevronsUp: od,
		ChevronsUpDown: vd,
		Chrome: sd,
		Church: rd,
		...
		CircleArrowDown: I,
		CircleArrowLeft: E,
		CircleArrowOutDownLeft: x,
		CircleArrowOutDownRight: W,
		...
		Fullscreen: Z7,
		FunctionSquare: a0,
		GalleryHorizontal: U7,
		GalleryHorizontalEnd: b7,
		GalleryThumbnails: O7,
		GalleryVertical: I7,
		GalleryVerticalEnd: G7,
		Gamepad: x7,
		Gamepad2: E7,
		GanttChart: b,
		GanttChartSquare: l,
		...
		GitMerge: dM,
		GitPullRequest: iM,
		GitPullRequestArrow: cM,
		GitPullRequestClosed: MM,
		GitPullRequestCreate: eM,
		GitPullRequestCreateArrow: pM,
		GitPullRequestDraft: nM,
		Github: lM,
		Gitlab: vM,
		GlassWater: oM,
		Glasses: sM,
		...
		MapPin: wn,
		MapPinCheck: sn,
		MapPinCheckInside: on,
		MapPinHouse: rn,
		MapPinMinus: yn,
		MapPinMinusInside: gn,
		MapPinOff: $n,
		MapPinPlus: Cn,
		MapPinPlusInside: mn,
		MapPinX: Hn,
		...
		Merge: zn,
		MessageCircle: Wn,
		MessageCircleCode: qn,
		MessageCircleDashed: Tn,
		MessageCircleHeart: Zn,
		MessageCircleMore: bn,
		MessageCircleOff: Un,
		MessageCirclePlus: On,
		MessageCircleQuestion: Gn,
		MessageCircleReply: In,
		MessageCircleWarning: En,
		MessageCircleX: xn,
		MessageSquare: e9,
		MessageSquareCode: Xn,
		MessageSquareDashed: Nn,
		MessageSquareDiff: Kn,
		MessageSquareDot: Jn,
		MessageSquareHeart: Qn,
		MessageSquareLock: jn,
		MessageSquareMore: Yn,
		MessageSquareOff: _n,
		MessageSquarePlus: a9,
		MessageSquareQuote: h9,
		MessageSquareReply: t9,
		MessageSquareShare: d9,
		MessageSquareText: c9,
		MessageSquareWarning: M9,
		MessageSquareX: p9,
		MessagesSquare: n9,
		Mic: l9,
		Mic2: a2,
		...
		MousePointer2: b9,
		MousePointerBan: U9,
		MousePointerClick: O9,
		MousePointerSquareDashed: J2,
		Move: hi,
		Move3D: h2,
		Move3d: h2,
		MoveDiagonal: x9,
		...
		Paintbrush: Zi,
		Paintbrush2: M2,
		PaintbrushVertical: M2,
		Palette: bi,
		Palmtree: f0,
		PanelBottom: Gi,
		PanelBottomClose: Ui,
		PanelBottomDashed: p2,
		PanelBottomInactive: p2,
		PanelBottomOpen: Oi,
		PanelLeft: l2,
		PanelLeftClose: e2,
		PanelLeftDashed: n2,
		...
		ReceiptCent: Cv,
		ReceiptEuro: uv,
		ReceiptIndianRupee: Hv,
		ReceiptJapaneseYen: wv,
		ReceiptPoundSterling: Vv,
		ReceiptRussianRuble: Av,
		ReceiptSwissFranc: Sv,
		ReceiptText: Lv,
		RectangleEllipsis: $2,
		RectangleHorizontal: Pv,
		RectangleVertical: kv,
		Recycle: Bv,
		Redo: Rv,
		Redo2: Fv,
		RedoDot: Dv,
		...
		School2: B0,
		Scissors: Do,
		ScissorsLineDashed: Fo,
		ScissorsSquare: g0,
		ScissorsSquareDashedBottom: O2,
		ScreenShare: zo,
		ScreenShareOff: Ro,
		Scroll: To,
		ScrollText: qo,
		...
		SendHorizontal: w2,
		SendToBack: Eo,
		SeparatorHorizontal: Wo,
		SeparatorVertical: Xo,
		Server: Qo,
		ServerCog: No,
		ServerCrash: Ko,
		ServerOff: Jo,
		...
		Slice: Os,
		Sliders: A2,
		SlidersHorizontal: Gs,
		SlidersVertical: A2,
		Smartphone: xs,
		SmartphoneCharging: Is,
		SmartphoneNfc: Es,
		Smile: Xs,
		SmilePlus: Ws,
		Snail: Ns,
		...
		Spline: cr,
		Split: Mr,
		SplitSquareHorizontal: m0,
		SplitSquareVertical: C0,
		SprayCan: pr,
		Sprout: er,
		Square: sr,
		SquareActivity: L2,
		...
		SquareArrowDownRight: P2,
		SquareArrowLeft: B2,
		SquareArrowOutDownLeft: F2,
		SquareArrowOutDownRight: D2,
		SquareArrowOutUpLeft: R2,
		SquareArrowOutUpRight: z2,
		SquareArrowRight: q2,
		SquareArrowUp: b2,
		SquareArrowUpLeft: T2,
		SquareArrowUpRight: Z2,
		SquareAsterisk: U2,
		SquareBottomDashedScissors: O2,
		SquareChartGantt: l,
		SquareCheck: I2,
		SquareCheckBig: G2,
		SquareChevronDown: E2,
		SquareChevronLeft: x2,
		SquareChevronRight: W2,
		SquareChevronUp: X2,
		SquareCode: N2,
		SquareDashed: Q2,
		SquareDashedBottom: ir,
		SquareDashedBottomCode: nr,
		SquareDashedKanban: K2,
		SquareDashedMousePointer: J2,
		SquareDivide: j2,
		SquareDot: Y2,
		SquareEqual: _2,
		SquareFunction: a0,
		...
		SquareSigma: y0,
		SquareSlash: $0,
		SquareSplitHorizontal: m0,
		SquareSplitVertical: C0,
		SquareSquare: vr,
		SquareStack: or,
		SquareTerminal: u0,
		SquareUser: w0,
...
lucide.createIcons({icons});\``);
		...
		if (
			(Array.from(p).forEach((M) => E0(M, { nameAttr: d, icons: t, attrs: c })),
			d === "data-lucide")
		) {
			...
			M.length > 0 &&
				...
				Array.from(M).forEach((v) =>
					E0(v, { nameAttr: "icon-name", icons: t, attrs: c }),
				));
		}
	};
	(a.AArrowDown = x0),
		...
		(a.AlertTriangle = P0),
		(a.AlignCenter = da),
		(a.AlignCenterHorizontal = ha),
		(a.AlignCenterVertical = ta),
		(a.AlignEndHorizontal = ca),
		(a.AlignEndVertical = Ma),
		(a.AlignHorizontalDistributeCenter = pa),
		(a.AlignHorizontalDistributeEnd = ea),
		(a.AlignHorizontalDistributeStart = na),
		(a.AlignHorizontalJustifyCenter = ia),
		(a.AlignHorizontalJustifyEnd = la),
		(a.AlignHorizontalJustifyStart = va),
		(a.AlignHorizontalSpaceAround = oa),
		(a.AlignHorizontalSpaceBetween = sa),
		(a.AlignJustify = ra),
		(a.AlignLeft = ga),
		(a.AlignRight = ya),
		(a.AlignStartHorizontal = $a),
		(a.AlignStartVertical = ma),
		(a.AlignVerticalDistributeCenter = Ca),
		(a.AlignVerticalDistributeEnd = ua),
		(a.AlignVerticalDistributeStart = Ha),
		(a.AlignVerticalJustifyCenter = wa),
		(a.AlignVerticalJustifyEnd = Va),
		(a.AlignVerticalJustifyStart = Aa),
		(a.AlignVerticalSpaceAround = Sa),
		(a.AlignVerticalSpaceBetween = La),
		(a.Ambulance = fa),
		(a.Ampersand = Pa),
		(a.Ampersands = ka),
		(a.Amphora = Ba),
		...
		(a.Armchair = Ea),
		(a.ArrowBigDown = Wa),
		(a.ArrowBigDownDash = xa),
		(a.ArrowBigLeft = Na),
		(a.ArrowBigLeftDash = Xa),
		(a.ArrowBigRight = Ja),
		(a.ArrowBigRightDash = Ka),
		(a.ArrowBigUp = ja),
		(a.ArrowBigUpDash = Qa),
		(a.ArrowDown = eh),
		(a.ArrowDown01 = Ya),
		...
		(a.ArrowDownAz = g),
		(a.ArrowDownCircle = I),
		(a.ArrowDownFromLine = ah),
		(a.ArrowDownLeft = hh),
		(a.ArrowDownLeftFromCircle = x),
		(a.ArrowDownLeftFromSquare = F2),
		(a.ArrowDownLeftSquare = f2),
		(a.ArrowDownNarrowWide = th),
		(a.ArrowDownRight = dh),
		(a.ArrowDownRightFromCircle = W),
		(a.ArrowDownRightFromSquare = D2),
		(a.ArrowDownRightSquare = P2),
		(a.ArrowDownSquare = k2),
		(a.ArrowDownToDot = ch),
		(a.ArrowDownToLine = Mh),
		(a.ArrowDownUp = ph),
		...
		(a.ArrowLeft = vh),
		(a.ArrowLeftCircle = E),
		(a.ArrowLeftFromLine = nh),
		(a.ArrowLeftRight = ih),
		(a.ArrowLeftSquare = B2),
		(a.ArrowLeftToLine = lh),
		(a.ArrowRight = gh),
		(a.ArrowRightCircle = K),
		(a.ArrowRightFromLine = oh),
		(a.ArrowRightLeft = sh),
		(a.ArrowRightSquare = q2),
		(a.ArrowRightToLine = rh),
		(a.ArrowUp = Sh),
		(a.ArrowUp01 = yh),
		(a.ArrowUp10 = $h),
		(a.ArrowUpAZ = m),
		...
		(a.ArrowUpDown = mh),
		(a.ArrowUpFromDot = Ch),
		(a.ArrowUpFromLine = uh),
		(a.ArrowUpLeft = Hh),
		(a.ArrowUpLeftFromCircle = X),
		(a.ArrowUpLeftFromSquare = R2),
		(a.ArrowUpLeftSquare = T2),
		(a.ArrowUpNarrowWide = C),
		(a.ArrowUpRight = wh),
		(a.ArrowUpRightFromCircle = N),
		(a.ArrowUpRightFromSquare = z2),
		(a.ArrowUpRightSquare = Z2),
		(a.ArrowUpSquare = b2),
		(a.ArrowUpToLine = Vh),
		(a.ArrowUpWideNarrow = Ah),
		(a.ArrowUpZA = u),
		(a.ArrowUpZa = u),
		(a.ArrowsUpFromLine = Lh),
		(a.Asterisk = fh),
		(a.AsteriskSquare = U2),
		(a.AtSign = Ph),
		(a.Atom = kh),
		...
		(a.BadgeCent = Zh),
		(a.BadgeCheck = w),
		(a.BadgeDollarSign = bh),
		(a.BadgeEuro = Uh),
		(a.BadgeHelp = Oh),
		(a.BadgeIndianRupee = Gh),
		(a.BadgeInfo = Ih),
		(a.BadgeJapaneseYen = Eh),
		(a.BadgeMinus = xh),
		(a.BadgePercent = Wh),
		(a.BadgePlus = Xh),
		(a.BadgePoundSterling = Nh),
		(a.BadgeRussianRuble = Kh),
		(a.BadgeSwissFranc = Jh),
		(a.BadgeX = Qh),
		(a.BaggageClaim = Yh),
		(a.Ban = _h),
		(a.Banana = at),
		...
		(a.BarChart4 = R),
		(a.BarChartBig = D),
		(a.BarChartHorizontal = B),
		(a.BarChartHorizontalBig = k),
		(a.Barcode = dt),
		(a.Baseline = ct),
		(a.Bath = Mt),
		(a.Battery = vt),
		(a.BatteryCharging = pt),
		(a.BatteryFull = et),
		(a.BatteryLow = nt),
		(a.BatteryMedium = it),
		(a.BatteryWarning = lt),
		...
		(a.BellPlus = St),
		(a.BellRing = Lt),
		(a.BetweenHorizonalEnd = V),
		(a.BetweenHorizonalStart = A),
		(a.BetweenHorizontalEnd = V),
		(a.BetweenHorizontalStart = A),
		(a.BetweenVerticalEnd = Pt),
		(a.BetweenVerticalStart = kt),
		(a.BicepsFlexed = Bt),
		(a.Bike = Ft),
		(a.Binary = Dt),
		(a.Binoculars = Rt),
		...
		(a.Blocks = Ut),
		(a.Bluetooth = Et),
		(a.BluetoothConnected = Ot),
		(a.BluetoothOff = Gt),
		(a.BluetoothSearching = It),
		(a.Bold = xt),
		(a.Bolt = Wt),
		(a.Bomb = Xt),
		(a.Bone = Nt),
		...
		(a.BrickWall = D4),
		(a.Briefcase = T4),
		(a.BriefcaseBusiness = R4),
		(a.BriefcaseConveyorBelt = z4),
		(a.BriefcaseMedical = q4),
		(a.BringToFront = Z4),
		(a.Brush = b4),
		(a.Bug = G4),
		(a.BugOff = U4),
		...
		(a.Calendar = $5),
		(a.Calendar1 = j4),
		(a.CalendarArrowDown = Y4),
		(a.CalendarArrowUp = _4),
		(a.CalendarCheck = h5),
		(a.CalendarCheck2 = a5),
		(a.CalendarClock = t5),
		(a.CalendarCog = d5),
		...
		(a.ChartBar = B),
		(a.ChartBarBig = k),
		(a.ChartBarDecreasing = b5),
		(a.ChartBarIncreasing = U5),
		(a.ChartBarStacked = O5),
		(a.ChartCandlestick = F),
		(a.ChartColumn = z),
		(a.ChartColumnBig = D),
		(a.ChartColumnDecreasing = G5),
		(a.ChartColumnIncreasing = R),
		(a.ChartColumnStacked = I5),
		(a.ChartGantt = E5),
		(a.ChartLine = q),
		(a.ChartNetwork = x5),
		(a.ChartNoAxesColumn = Z),
		(a.ChartNoAxesColumnDecreasing = W5),
		(a.ChartNoAxesColumnIncreasing = T),
		(a.ChartNoAxesCombined = X5),
		(a.ChartNoAxesGantt = b),
		(a.ChartPie = U),
		(a.ChartScatter = O),
		(a.ChartSpline = N5),
		(a.Check = J5),
		...
		(a.Cherry = j5),
		(a.ChevronDown = Y5),
		(a.ChevronDownCircle = Y),
		(a.ChevronDownSquare = E2),
		(a.ChevronFirst = _5),
		(a.ChevronLast = ad),
		(a.ChevronLeft = hd),
		(a.ChevronLeftCircle = _),
		(a.ChevronLeftSquare = x2),
		(a.ChevronRight = td),
		(a.ChevronRightCircle = a1),
		(a.ChevronRightSquare = W2),
		(a.ChevronUp = dd),
		(a.ChevronUpCircle = h1),
		(a.ChevronUpSquare = X2),
		(a.ChevronsDown = Md),
		(a.ChevronsDownUp = cd),
		(a.ChevronsLeft = nd),
		(a.ChevronsLeftRight = ed),
		(a.ChevronsLeftRightEllipsis = pd),
		(a.ChevronsRight = ld),
		(a.ChevronsRightLeft = id),
		(a.ChevronsUp = od),
		(a.ChevronsUpDown = vd),
		(a.Chrome = sd),
		(a.Church = rd),
		...
		(a.CircleArrowDown = I),
		(a.CircleArrowLeft = E),
		(a.CircleArrowOutDownLeft = x),
		(a.CircleArrowOutDownRight = W),
		(a.CircleArrowOutUpLeft = X),
		(a.CircleArrowOutUpRight = N),
		(a.CircleArrowRight = K),
		(a.CircleArrowUp = J),
		(a.CircleCheck = j),
		(a.CircleCheckBig = Q),
		(a.CircleChevronDown = Y),
		(a.CircleChevronLeft = _),
		(a.CircleChevronRight = a1),
		(a.CircleChevronUp = h1),
		(a.CircleDashed = $d),
		(a.CircleDivide = t1),
		(a.CircleDollarSign = md),
		(a.CircleDot = ud),
		(a.CircleDotDashed = Cd),
		(a.CircleEllipsis = Hd),
		(a.CircleEqual = wd),
		(a.CircleFadingArrowUp = Vd),
		(a.CircleFadingPlus = Ad),
		(a.CircleGauge = d1),
		(a.CircleHelp = c1),
		(a.CircleMinus = M1),
		(a.CircleOff = Sd),
		(a.CircleParking = e1),
		(a.CircleParkingOff = p1),
		(a.CirclePause = n1),
		(a.CirclePercent = i1),
		(a.CirclePlay = l1),
		(a.CirclePlus = v1),
		...
		(a.ClipboardPaste = qd),
		(a.ClipboardPen = C1),
		(a.ClipboardPenLine = m1),
		(a.ClipboardPlus = Td),
		(a.ClipboardSignature = m1),
		(a.ClipboardType = Zd),
		(a.ClipboardX = bd),
		(a.Clock = h3),
		(a.Clock1 = Od),
		...
		(a.Copyright = N3),
		(a.CornerDownLeft = K3),
		(a.CornerDownRight = J3),
		(a.CornerLeftDown = Q3),
		(a.CornerLeftUp = j3),
		(a.CornerRightDown = Y3),
		(a.CornerRightUp = _3),
		(a.CornerUpLeft = a6),
		(a.CornerUpRight = h6),
		(a.Cpu = t6),
		(a.CreativeCommons = d6),
		(a.CreditCard = c6),
		(a.Croissant = M6),
		(a.Crop = p6),
		(a.Cross = e6),
		...
		(a.FileChartColumnIncreasing = F1),
		(a.FileChartLine = R1),
		(a.FileChartPie = z1),
		(a.FileCheck = Tc),
		(a.FileCheck2 = qc),
		...
		(a.FilterX = P8),
		(a.Fingerprint = B8),
		(a.FireExtinguisher = F8),
		(a.Fish = z8),
		(a.FishOff = D8),
		(a.FishSymbol = R8),
		(a.Flag = b8),
		(a.FlagOff = q8),
		(a.FlagTriangleLeft = T8),
		(a.FlagTriangleRight = Z8),
		(a.Flame = O8),
		(a.FlameKindling = U8),
		(a.Flashlight = I8),
		(a.FlashlightOff = G8),
		(a.FlaskConical = x8),
		(a.FlaskConicalOff = E8),
		(a.FlaskRound = W8),
		(a.FlipHorizontal = N8),
		(a.FlipHorizontal2 = X8),
		(a.FlipVertical = J8),
		(a.FlipVertical2 = K8),
		(a.Flower = j8),
		(a.Flower2 = Q8),
		...
		(a.Fullscreen = Z7),
		(a.FunctionSquare = a0),
		(a.GalleryHorizontal = U7),
		(a.GalleryHorizontalEnd = b7),
		(a.GalleryThumbnails = O7),
		(a.GalleryVertical = I7),
		(a.GalleryVerticalEnd = G7),
		(a.Gamepad = x7),
		(a.Gamepad2 = E7),
		(a.GanttChart = b),
		...
		(a.GitBranchPlus = Q7),
		(a.GitCommit = O1),
		(a.GitCommitHorizontal = O1),
		(a.GitCommitVertical = Y7),
		(a.GitCompare = aM),
		(a.GitCompareArrows = _7),
		(a.GitFork = hM),
		(a.GitGraph = tM),
		(a.GitMerge = dM),
		(a.GitPullRequest = iM),
		(a.GitPullRequestArrow = cM),
		(a.GitPullRequestClosed = MM),
		(a.GitPullRequestCreate = eM),
		(a.GitPullRequestCreateArrow = pM),
		(a.GitPullRequestDraft = nM),
		(a.Github = lM),
		(a.Gitlab = vM),
		(a.GlassWater = oM),
		(a.Glasses = sM),
		...
		(a.Handshake = zM),
		(a.HardDrive = ZM),
		(a.HardDriveDownload = qM),
		(a.HardDriveUpload = TM),
		(a.HardHat = bM),
		(a.Hash = UM),
		(a.Haze = OM),
		(a.HdmiPort = GM),
		...
		(a.Layers3 = Q1),
		(a.Layout = s2),
		(a.LayoutDashboard = ce),
		(a.LayoutGrid = Me),
		(a.LayoutList = pe),
		(a.LayoutPanelLeft = ee),
		(a.LayoutPanelTop = ne),
		(a.LayoutTemplate = ie),
		(a.Leaf = le),
		(a.LeafyGreen = ve),
		...
		(a.MapPin = wn),
		(a.MapPinCheck = sn),
		(a.MapPinCheckInside = on),
		(a.MapPinHouse = rn),
		(a.MapPinMinus = yn),
		(a.MapPinMinusInside = gn),
		(a.MapPinOff = $n),
		(a.MapPinPlus = Cn),
		(a.MapPinPlusInside = mn),
		(a.MapPinX = Hn),
		(a.MapPinXInside = un),
		(a.MapPinned = Vn),
		(a.Martini = Sn),
		...
		(a.Merge = zn),
		(a.MessageCircle = Wn),
		(a.MessageCircleCode = qn),
		(a.MessageCircleDashed = Tn),
		(a.MessageCircleHeart = Zn),
		(a.MessageCircleMore = bn),
		(a.MessageCircleOff = Un),
		(a.MessageCirclePlus = On),
		(a.MessageCircleQuestion = Gn),
		(a.MessageCircleReply = In),
		(a.MessageCircleWarning = En),
		(a.MessageCircleX = xn),
		(a.MessageSquare = e9),
		(a.MessageSquareCode = Xn),
		(a.MessageSquareDashed = Nn),
		(a.MessageSquareDiff = Kn),
		(a.MessageSquareDot = Jn),
		(a.MessageSquareHeart = Qn),
		(a.MessageSquareLock = jn),
		(a.MessageSquareMore = Yn),
		(a.MessageSquareOff = _n),
		(a.MessageSquarePlus = a9),
		(a.MessageSquareQuote = h9),
		(a.MessageSquareReply = t9),
		(a.MessageSquareShare = d9),
		(a.MessageSquareText = c9),
		(a.MessageSquareWarning = M9),
		(a.MessageSquareX = p9),
		(a.MessagesSquare = n9),
		(a.Mic = l9),
		(a.Mic2 = a2),
		...
		(a.MousePointer = G9),
		(a.MousePointer2 = b9),
		(a.MousePointerBan = U9),
		(a.MousePointerClick = O9),
		(a.MousePointerSquareDashed = J2),
		(a.Move = hi),
		(a.Move3D = h2),
		(a.Move3d = h2),
		(a.MoveDiagonal = x9),
		...
		(a.Paintbrush = Zi),
		(a.Paintbrush2 = M2),
		(a.PaintbrushVertical = M2),
		(a.Palette = bi),
		(a.Palmtree = f0),
		(a.PanelBottom = Gi),
		(a.PanelBottomClose = Ui),
		(a.PanelBottomDashed = p2),
		(a.PanelBottomInactive = p2),
		(a.PanelBottomOpen = Oi),
		(a.PanelLeft = l2),
		(a.PanelLeftClose = e2),
		(a.PanelLeftDashed = n2),
		(a.PanelLeftInactive = n2),
		(a.PanelLeftOpen = i2),
		(a.PanelRight = xi),
		(a.PanelRightClose = Ii),
		(a.PanelRightDashed = v2),
		(a.PanelRightInactive = v2),
		(a.PanelRightOpen = Ei),
		(a.PanelTop = Ni),
		(a.PanelTopClose = Wi),
		(a.PanelTopDashed = o2),
		(a.PanelTopInactive = o2),
		(a.PanelTopOpen = Xi),
		(a.PanelsLeftBottom = Ki),
		(a.PanelsLeftRight = A1),
		(a.PanelsRightBottom = Ji),
		(a.PanelsTopBottom = u2),
		(a.PanelsTopLeft = s2),
		(a.Paperclip = Qi),
		(a.Parentheses = ji),
		(a.ParkingCircle = e1),
		(a.ParkingCircleOff = p1),
		(a.ParkingMeter = Yi),
		(a.ParkingSquare = n0),
		(a.ParkingSquareOff = e0),
		(a.PartyPopper = _i),
		(a.Pause = al),
		(a.PauseCircle = n1),
		(a.PauseOctagon = d2),
		...
		(a.Piano = Hl),
		(a.Pickaxe = wl),
		(a.PictureInPicture = Al),
		(a.PictureInPicture2 = Vl),
		(a.PieChart = U),
		(a.PiggyBank = Sl),
		(a.Pilcrow = Pl),
		(a.PilcrowLeft = Ll),
		...
		(a.ReceiptCent = Cv),
		(a.ReceiptEuro = uv),
		(a.ReceiptIndianRupee = Hv),
		(a.ReceiptJapaneseYen = wv),
		(a.ReceiptPoundSterling = Vv),
		(a.ReceiptRussianRuble = Av),
		(a.ReceiptSwissFranc = Sv),
		(a.ReceiptText = Lv),
		(a.RectangleEllipsis = $2),
		(a.RectangleHorizontal = Pv),
		(a.RectangleVertical = kv),
		(a.Recycle = Bv),
		(a.Redo = Rv),
		(a.Redo2 = Fv),
		(a.RedoDot = Dv),
		...
		(a.School2 = B0),
		(a.Scissors = Do),
		(a.ScissorsLineDashed = Fo),
		(a.ScissorsSquare = g0),
		(a.ScissorsSquareDashedBottom = O2),
		(a.ScreenShare = zo),
		(a.ScreenShareOff = Ro),
		(a.Scroll = To),
		(a.ScrollText = qo),
		...
		(a.SendHorizontal = w2),
		(a.SendToBack = Eo),
		(a.SeparatorHorizontal = Wo),
		(a.SeparatorVertical = Xo),
		(a.Server = Qo),
		(a.ServerCog = No),
		(a.ServerCrash = Ko),
		(a.ServerOff = Jo),
		...
		(a.Slice = Os),
		(a.Sliders = A2),
		(a.SlidersHorizontal = Gs),
		(a.SlidersVertical = A2),
		(a.Smartphone = xs),
		(a.SmartphoneCharging = Is),
		(a.SmartphoneNfc = Es),
		(a.Smile = Xs),
		(a.SmilePlus = Ws),
		(a.Snail = Ns),
		...
		(a.Spline = cr),
		(a.Split = Mr),
		(a.SplitSquareHorizontal = m0),
		(a.SplitSquareVertical = C0),
		(a.SprayCan = pr),
		(a.Sprout = er),
		(a.Square = sr),
		(a.SquareActivity = L2),
		(a.SquareArrowDown = k2),
		(a.SquareArrowDownLeft = f2),
		(a.SquareArrowDownRight = P2),
		(a.SquareArrowLeft = B2),
		(a.SquareArrowOutDownLeft = F2),
		(a.SquareArrowOutDownRight = D2),
		(a.SquareArrowOutUpLeft = R2),
		(a.SquareArrowOutUpRight = z2),
		(a.SquareArrowRight = q2),
		(a.SquareArrowUp = b2),
		(a.SquareArrowUpLeft = T2),
		(a.SquareArrowUpRight = Z2),
		(a.SquareAsterisk = U2),
		(a.SquareBottomDashedScissors = O2),
		(a.SquareChartGantt = l),
		(a.SquareCheck = I2),
		(a.SquareCheckBig = G2),
		(a.SquareChevronDown = E2),
		(a.SquareChevronLeft = x2),
		(a.SquareChevronRight = W2),
		(a.SquareChevronUp = X2),
		(a.SquareCode = N2),
		(a.SquareDashed = Q2),
		(a.SquareDashedBottom = ir),
		(a.SquareDashedBottomCode = nr),
		(a.SquareDashedKanban = K2),
		(a.SquareDashedMousePointer = J2),
		(a.SquareDivide = j2),
		(a.SquareDot = Y2),
		(a.SquareEqual = _2),
		(a.SquareFunction = a0),
		(a.SquareGanttChart = l),
		(a.SquareKanban = h0),
		(a.SquareLibrary = t0),
		(a.SquareM = d0),
		(a.SquareMenu = c0),
		(a.SquareMinus = M0),
		(a.SquareMousePointer = p0),
		(a.SquareParking = n0),
		(a.SquareParkingOff = e0),
		(a.SquarePen = e),
		(a.SquarePercent = i0),
		(a.SquarePi = l0),
		(a.SquarePilcrow = v0),
		...
		(a.SquareSigma = y0),
		(a.SquareSlash = $0),
		(a.SquareSplitHorizontal = m0),
		(a.SquareSplitVertical = C0),
		(a.SquareSquare = vr),
		(a.SquareStack = or),
		(a.SquareTerminal = u0),
		(a.SquareUser = w0),
		(a.SquareUserRound = H0),
		(a.SquareX = V0),
		(a.Squircle = rr),
		(a.Squirrel = gr),
		(a.Stamp = yr),
		...
		(a.StopCircle = r1),
		(a.Store = Sr),
		(a.StretchHorizontal = Lr),
		(a.StretchVertical = fr),
		(a.Strikethrough = Pr),
		(a.Subscript = kr),
		(a.Subtitles = f),
		(a.Sun = zr),
		...
		(a.Table = jr),
		(a.Table2 = xr),
		(a.TableCellsMerge = Wr),
		(a.TableCellsSplit = Xr),
		(a.TableColumnsSplit = Nr),
		(a.TableOfContents = Kr),
		(a.TableProperties = Jr),
		(a.TableRowsSplit = Qr),
		(a.Tablet = _r),
		(a.TabletSmartphone = Yr),
		(a.Tablets = ag),
		(a.Tag = hg),
		(a.Tags = tg),
		(a.Tally1 = dg),
		...
		(a.TestTube = rg),
		(a.TestTube2 = A0),
		(a.TestTubeDiagonal = A0),
		(a.TestTubes = gg),
		(a.Text = ug),
		(a.TextCursor = $g),
		(a.TextCursorInput = yg),
		(a.TextQuote = mg),
		(a.TextSearch = Cg),
		(a.TextSelect = S0),
		(a.TextSelection = S0),
