	...
	(t = () => {
		...
		function t(t) {
			for (let n = 1; n < arguments.length; n++) {
				...
				n % 2
					? e(Object(r), !0).forEach((e) => {
							o(t, e, r[e]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(t, Object.getOwnPropertyDescriptors(r))
						: e(Object(r)).forEach((e) => {
		...
		function C(e) {
			return (
				!0 === e ||
				!1 === e ||
				(((e) => k(e) && null !== e)(e) && "[object Boolean]" === M(e))
			);
		}
		function k(e) {
			return "object" === n(e);
		...
		const b = (e) => "Missing ".concat(e, " property in key"),
			D = (e) =>
				"Property 'weight' in key '".concat(e, "' must be a positive integer"),
			...
			x = (() => {
				function e(t) {
					...
					t.forEach((e) => {
						const t = w(e);
						this._keys.push(t), (this._keyMap[t.id] = t), (i += t.weight);
					}),
							...
							if (E(t))
								if (i[u]) {
									...
									if (u === i.length - 1 && (A(o) || m(o) || C(o)))
										...
										r = !0;
										for (let c = 0, a = o.length; c < a; c += 1)
											e(o[c], i, u + 1);
						...
						},
						{
							...
							value: function (e, t) {
								...
								this.keys.forEach((t, i) => {
									const u = t.getFn ? t.getFn(e) : this.getFn(e, t.path);
									if (E(u))
										if (g(u)) {
											for (
												...
												if (E(h))
													if (A(h) && !F(h)) {
														const l = { v: h, i: s, n: this.norm.get(h) };
														o.push(l);
													} else
														g(h) &&
															h.forEach((e, t) => {
		...
		function P(e, t, n) {
			...
			const q = { isMatch: F >= 0, score: Math.max(0.001, w) };
			if (M) {
				const J = (function () {
					for (
						var e =
		...
		const z = String.prototype.normalize
				? (e) =>
						e
							.normalize("NFD")
							.replace(
					...
					u(e, [
						{
							...
							value: function (e) {
								...
								const p = { isMatch: y, score: y ? g / this.chunks.length : 1 };
		...
		const J = ((e) => {
			...
			G = ((e) => {
				...
				return (
					u(
						...
						[
							{ key: "type", get: () => "inverse-prefix-exact" },
							{ key: "multiRegex", get: () => /^!\^"(.*)"$/ },
							{ key: "singleRegex", get: () => /^!\^(.*)$/ },
						],
					),
			...
			Q = ((e) => {
				...
				return (
					u(
						...
						[
							{ key: "type", get: () => "inverse-suffix-exact" },
							{ key: "multiRegex", get: () => /^!"(.*)"\$$/ },
							{ key: "singleRegex", get: () => /^!(.*)\$$/ },
						],
					),
			...
			re = (() => {
				...
				return (
					u(
						...
						[
							{
								...
								value: function (e) {
									...
									for (
										let o = 0, c = [], a = 0, s = 0, h = t.length;
										s < h;
										s += 1
									) {
										const l = t[s];
										(c.length = 0), (o = 0);
										for (let d = 0, v = l.length; d < v; d += 1) {
											const g = l[d],
												y = g.search(e),
												p = y.isMatch,
												A = y.indices,
						...
						[{ key: "condition", value: (_e, t) => t.useExtendedSearch }],
					),
					e
				);
			})(),
			ie = [];
		function ue(e, t) {
			for (let n = 0, r = ie.length; n < r; n += 1) {
				const i = ie[n];
				...
				(function e(n) {
					...
					if (((e) => !g(e) && k(e) && !he(e))(n)) {
						const o = u ? n[ae] : i[0],
							c = u ? n[se] : n[o];
						if (!A(c))
							throw new Error(((e) => "Invalid value for key ".concat(e))(o));
						const a = { keyId: L(o), pattern: c };
						return r && (a.searcher = ue(c, t)), a;
					}
					const s = { children: [], operator: i[0] };
					return (
						i.forEach((t) => {
							const r = n[t];
							g(r) &&
							...
							const t = this,
								...
								r = function e(n, r, i) {
									if (!n.children) {
										...
										return c?.length ? [{ idx: i, item: r, matches: c }] : [];
									}
									for (
