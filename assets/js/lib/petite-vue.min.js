...
const nt = (e, t, n) =>
	t in e
		...
		: (e[t] = n);
const $ = (e, t, n) => (nt(e, typeof t !== "symbol" ? `${t}` : t, n), n);
function st(e, t) {
...
const lt = Object.assign,
	...
	ht = /-(\w)/g,
	dt = be((e) => e.replace(ht, (_t, n) => (n ? n.toUpperCase() : ""))),
	mt = /\B([A-Z])/g,
...
let yt;
function we(e, t) {
	(t = t || yt), t?.active && t.effects.push(e);
}
const _e = (e) => {
		const t = new Set(e);
...
class vt {
	...
	stop() {
		this.active && (Oe(this), this.onStop?.(), (this.active = !1));
	}
}
function Oe(e) {
	const { deps: t } = e;
...
function wt(e, t) {
	...
	const n = new vt(e);
	t && (lt(n, t), t.scope && we(n, t.scope)), !t?.lazy && n.run();
...
function Ot(e, _t) {
	let n = !1;
	B <= te ? $e(e) || ((e.n |= O), (n = !Ee(e))) : (n = !e.has(C)),
		n && (e.add(C), C.deps.push(e));
}
function se(e, t, n, s, _r, _i) {
	const c = ee.get(e);
	if (!c) return;
	let o = [];
	if (t === "clear") o = [...c.values()];
		...
		switch ((n !== void 0 && o.push(c.get(n)), t)) {
			case "add":
				y(e)
					? X(n) && o.push(c.get("length"))
					: (o.push(c.get(W)), Y(e) && o.push(c.get(Se)));
				break;
			case "delete":
...
function Me(e = !1, t = !1) {
	return (s, r, i) => {
		...
		return (Q(r) ? Ae.has(r) : kt(r)) || (e || F(s, "get", r), t)
			? o
			: re(o)
				? !c || !X(r)
					? o.value
...
function Ct(e = !1) {
	return (n, s, r, i) => {
		...
		if (!e && !Lt(r) && ((r = j(r)), (c = j(c)), !y(n) && re(c) && !re(r)))
			return (c.value = r), !0;
		const o = y(n) && X(s) ? Number(s) < n.length : U(n, s),
			l = Reflect.set(n, s, r, i);
		return (
			n === j(i) && (o ? gt(r, c) && se(n, "set", s, r) : se(n, "add", s, r)), l
		);
	};
}
function jt(e, t) {
...
function D(e) {
	return e?.__v_isReadonly ? e : Pe(e, !1, Nt, null, Ce);
}
function Ht(e) {
...
const q = [],
	...
	ie = ({ el: e, get: t, effect: n, arg: s, modifiers: r }) => {
		let i;
		s === "class" && (e._class = e.className),
			n(() => {
				const c = t();
				if (s) (r == null ? void 0 : r.camel) && (s = dt(s)), ce(e, s, c, i);
				else {
					for (const o in c) ce(e, o, c[o], i?.[o]);
	...
	ce = (e, t, n, s) => {
		if (t === "class")
			...
			!(e instanceof SVGElement) && t in e && !qt.test(t)
				? ((e[t] = n), t === "value" && (e._value = n))
				: t === "true-value"
					? (e._trueValue = n)
					: t === "false-value"
						? (e._falseValue = n)
	...
	le = (e, t, n) => {
		y(n)
			? n.forEach((s) => le(e, t, s))
			: t.startsWith("--")
				? e.setProperty(t, n)
				: Ne.test(n)
					? e.setProperty(xe(t), n.replace(Ne, ""), "important")
					: (e[t] = n);
	},
	k = (e, t) => {
	...
	Qt = ({ el: e, exp: t, get: n, effect: s, modifiers: r }) => {
		const i = e.type,
			c = n(`(val) => { ${t} = val }`),
			{ trim: o, number: l = i === "number" } = r || {};
		if (e.tagName === "SELECT") {
			const f = e;
			T(e, "change", () => {
				const a = Array.prototype.filter
					.call(f.options, (u) => u.selected)
					.map((u) => (l ? ve(A(u)) : A(u)));
				c(f.multiple ? a : a[0]);
			}),
				s(() => {
			...
			T(e, "compositionstart", Xt),
				T(e, "compositionend", en),
				T(e, (r == null ? void 0 : r.lazy) ? "change" : "input", () => {
				...
				s(() => {
					...
					const a = e.value,
						u = n();
					(document.activeElement === e && f(a) === u) ||
						(a !== u && (e.value = u));
				});
		}
	},
	...
	on = (e, t, n) => {
		...
		for (
			...
			((o = null), k(c, "v-else") === "" || (o = k(c, "v-else-if")));
		)
	...
	an = (e, t, n) => {
		...
		const o = s[2].trim();
		let l = s[1].trim().replace(ln, "").trim(),
			f,
			a = !1,
			u,
			p,
			...
			b =
				e.getAttribute(x) ||
				e.getAttribute((x = ":key")) ||
				e.getAttribute((x = "v-bind:key"));
		...
		(v = l.match(Le)) &&
			...
			v[2] && (p = v[2].trim())),
			(v = l.match(fn)) &&
				((f = v[1].split(",").map((m) => m.trim())), (a = l[0] === "["));
		let pe = !1,
			R,
			L,
			J;
		const et = (m) => {
			...
			Z = (m, w, h, d) => {
				const g = {};
				f ? f.forEach((M, E) => (g[M] = w[a ? E : M])) : (g[l] = w),
					d ? (u && (g[u] = d), p && (g[p] = h)) : u && (g[u] = h);
				const P = Ge(n, g),
					_ = b ? H(P.scope, b) : h;
		...
		return (
			n.effect(() => {
				const m = H(n.scope, o),
					w = J;
				if ((([L, J] = et(m)), !pe)) (R = L.map((h) => he(h, c))), (pe = !0);
				else {
					...
					for (; d--; ) {
						...
						M == null
							? (E = he(_, g ? g.el : c))
							: ((E = R[M]),
								Object.assign(E.ctx.scope, _.scope),
								M !== d &&
									(R[M + 1] !== g || P === g) &&
									((P = E), E.insert(i, g ? g.el : c))),
							h.unshift((g = E));
					}
					R = h;
				}
		...
		if (n === 1) {
			...
			if (s.includes(t.delimiters[0])) {
				...
				for (; (c = t.delimitersRE.exec(s)); ) {
					...
					o && r.push(JSON.stringify(o)),
						r.push(`$s(${c[1]})`),
						(i = c.index + c[0].length);
				}
				i < s.length && r.push(JSON.stringify(s.slice(i))),
					ae(e, Be, r.join("+"), t);
			}
		} else n === 11 && qe(e, t);
	},
...
class ue {
	constructor(t, n, s = !1) {
		...
		(this.isFragment = t instanceof HTMLTemplateElement),
			...
			s
				? (this.ctx = n)
				: ((this.parentCtx = n), n.blocks.push(this), (this.ctx = Ze(n))),
	...
	insert(t, n = null) {
		if (this.isFragment)
			if (this.start) {
				...
				for (
					;
					s && ((r = s.nextSibling), t.insertBefore(s, n), s !== this.end);
				)
					s = r;
			} else
				(this.start = new Text("")),
					(this.end = new Text("")),
					t.insertBefore(this.end, n),
...
Xe?.hasAttribute("init") && Qe().mount();

export { D as reactive, Qe as createApp, V as nextTick };
