...
function observePosition(el) {
	...
	oldObserver === null || oldObserver === void 0
		? void 0
...
function updatePos(el) {
	...
	debounces.set(
		...
		setTimeout(async () => {
			...
			try {
				await (currentAnimation === null || currentAnimation === void 0
					? void 0
...
function cleanUp(el, styles) {
	...
	(_a = intersections.get(el)) === null || _a === void 0
		? void 0
		: _a.disconnect();
	setTimeout(() => {
...
function remove(el) {
	...
	if (next?.parentNode && next.parentNode instanceof Element) {
		...
		(_a = getTarget(el)) === null || _a === void 0
			? void 0
			: _a.appendChild(el);
	}
