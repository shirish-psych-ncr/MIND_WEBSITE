...
function startTransition(targetSide) {
	...
	document
		.getElementById("L")
		.style.setProperty("--cyan", targetSide === "L" ? "#22d3ee" : "#a855f7");
	document
		.getElementById("R")
		.style.setProperty("--cyan", targetSide === "L" ? "#22d3ee" : "#a855f7");
...
function triggerSupernova() {
	...
	setTimeout(() => {
		...
		// Deepen Sound
		if (osc) {
			const newFreq = Math.max(200, 432 - count * 2);
