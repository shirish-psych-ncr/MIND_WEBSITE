 ...
 */
declare function parse$1(data: string, options?: Partial<Options>): HTMLElement;
//#endregion
//#region src/valid.d.ts
/**
 * Parses HTML and returns a root element
 * Parse a chuck of HTML source.
 */
declare function valid(data: string, options?: Partial<Options>): boolean;
//#endregion
//#region src/nodes/comment.d.ts
