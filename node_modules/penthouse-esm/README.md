...
> Critical Path CSS Generator (ESM fork of [penthouse](https://github.com/pocketjoso/penthouse))
...
This is a maintained ESM-only fork of [pocketjoso/penthouse](https://github.com/pocketjoso/penthouse) with updated dependencies (Puppeteer 25, css-tree 3, Node 22+).
...
```
pnpm add -D penthouse-esm
```

(or `npm install -D penthouse-esm` / `yarn add -D penthouse-esm`)
...
https://github.com/bezoerb/penthouse-esm/tree/main/examples
...
There's only so many jobs you can run in parallel before your machine starts running out of resources. To run many jobs effectively, see the [many urls example](https://github.com/bezoerb/penthouse-esm/tree/main/examples/many-urls.js).
...
| screenshots                   | `object`                                     |                                                                                                             | Configuration for screenshots (not used by default). See [Screenshot example](https://github.com/bezoerb/penthouse-esm/tree/main/examples/screenshots.js)                                                                                                                                                                                                                                                                    |
...
| puppeteer                     | `object`                                     |                                                                                                             | Settings for puppeteer. See [Custom puppeteer browser example](https://github.com/bezoerb/penthouse-esm/tree/main/examples/custom-browser.js)                                                                                                                                                                                                                                                                                |
...
[npm-image]: https://badge.fury.io/js/penthouse-esm.svg
[npm-url]: https://npmjs.org/package/penthouse-esm
[dlcounter-image]: https://img.shields.io/npm/dm/penthouse-esm.svg?style=flat
