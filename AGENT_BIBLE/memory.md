...
**ID:** mg-003 | **T:** +8 | **Φ:** AGENT_BIBLE_v3.0_SYNCED
...
- **Core:** index.html (561L, v2.1), styles.css (2089L, v3.0), app.js (685L) → worker.md §10
...
8. Next: T9 (Begin Astro scaffold, component primitives) → worker.md §1, pages.md §6
