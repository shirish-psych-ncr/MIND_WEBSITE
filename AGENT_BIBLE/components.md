...
<body>
  ...
  <main id="main-content" role="main">
    ...
    <section
      class="main-section section-light"
...
<!-- Slightly warmer -->
<section class="section section-off-white">...</section>
<!-- Card sections -->
```
...
<header class="site-header" role="banner">
  <div class="header-inner">
    <a href="index.html" class="logo-link" aria-label="Mind Grace Home">
      <img
        src="./res/Mind_Grace_Clinic_Logo_Pink.svg"
        alt="..."
        class="logo-img"
        width="180"
        height="60"
  ...
  <div class="hero-content">
    <div class="hero-text">
      ...
      <span class="hero-badge">
        ...
        >
          <path
            d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.34 2 9.27l6.91-1.01L12 2z"
          />
        </svg>
        You Matter Here
      </span>
      ...
      <p class="hero-subtitle" style="max-width: 540px; line-height: 1.7;">
        At Mind Grace Neuropsychiatric Clinic, everything revolves around
        <strong class="text-primary">you</strong>. Whether you're navigating
        anxiety, seeking support for your child, or finding balance again—Dr.
        Anita Sharma and our compassionate team are here.
      </p>
...
<article class="card">
  ...
  <div
    class="card-icon"
    aria-hidden="true"
    style="background: var(--pastel-lavender); width: 72px; height: 72px;"
  >
    <svg
      class="icon icon-lg"
      viewBox="0 0 24 24"
